...
export const desktopPolicyDefinitions = [
  {
    ...
    description:
      "Allow users to add and use models that are not deployed through Owl WorkMate Cloud.",
    userNotice:
  ...
  },
  {
    ...
    description:
      "Allow users to see and use Owl WorkMate's built-in extensions, including browser, image, and local-provider extensions.",
    userNotice:
      "Your organization administrator has disabled built-in Owl WorkMate extensions.",
    defaultValue: true,
  },
  {
    id: "showWelcomePage",
