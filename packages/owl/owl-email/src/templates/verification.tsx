...
export function VerificationEmail({ verificationCode }: VerificationEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Your Owl WorkMate verification code is {verificationCode}</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.eyebrow}>Owl WorkMate</Text>
          <Heading style={styles.heading}>Verify your email</Heading>
          <Text style={styles.text}>Enter this code to finish signing in to Owl WorkMate.</Text>
