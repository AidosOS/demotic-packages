...
export function FeedbackEmail({
  ...
  const metadata = [
    ...
    ["Owl WorkMate server", OpenWorkServerVersion],
  ...
  return (
    <Html>
      <Head />
      <Preview>{name} sent Owl WorkMate feedback from {entrypoint || source || "unknown"}</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.eyebrow}>Owl WorkMate feedback</Text>
