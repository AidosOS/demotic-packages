...
export function DownloadLinkEmail({ organizationName, downloadUrl }: DownloadLinkEmailProps) {
  const intro = organizationName
    ? `Here's your link to download the Owl WorkMate desktop app for ${organizationName}.`
    : "Here's your link to download the Owl WorkMate desktop app."

  return (
    <Html>
      <Head />
      <Preview>Your Owl WorkMate download link</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.eyebrow}>Owl WorkMate desktop</Text>
          <Heading style={styles.heading}>Download Owl WorkMate</Heading>
          ...
          <Button href={downloadUrl} style={styles.button}>Download Owl WorkMate</Button>
