...
export function OrganizationInviteEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>{invitedByName} invited you to join {organizationName} on Owl WorkMate</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.eyebrow}>Owl WorkMate invite</Text>
          ...
          <Section style={styles.desktopSection}>
            <Text style={styles.sectionHeading}>What you&apos;ll get in the Owl WorkMate desktop app</Text>
