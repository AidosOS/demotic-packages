 ...
 *
 * Usage:
 *   pnpm --filter @demotic/owl-ee-den-db db:baseline              # dry run
 *   pnpm --filter @demotic/owl-ee-den-db db:baseline -- --yes     # apply
 *   pnpm --filter @demotic/owl-ee-den-db db:baseline -- --yes --through 0020_breezy_siren
 *
