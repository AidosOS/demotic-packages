...
const FALLBACK_RELEASE = "https://github.com/AidosOS/demotic-owl-workmate/releases"
    ...
    >
      <div className="bg-gradient-to-b from-[#FAFBFE] to-white px-6 py-5">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-[16px] font-semibold text-[#07192C]">Download Owl WorkMate</span>
          {tag ? (
