...
Kreiraj `.Clisis Coder/commands/test.md`:
...
Možete dodati prilagođene komande kroz Clisis Coder konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Clisis Coder [config](/docs/config):
...
- Globalno: `~/.config/Clisis Coder/commands/`
- Po projektu: `.Clisis Coder/commands/`
...
Clisis Coder uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
