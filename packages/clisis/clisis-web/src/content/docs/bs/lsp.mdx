---
title: LSP serveri
description: Clisis Coder se integriše sa vašim LSP serverima.
---

Clisis Coder se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Clisis Coder dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `Clisis Coder_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i Clisis Coder otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj Clisis Coder konfiguraciji.
