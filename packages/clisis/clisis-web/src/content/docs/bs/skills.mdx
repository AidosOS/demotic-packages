...
Agent skills omogucavaju Clisis Coder da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Clisis Coder pretrazuje ove lokacije:

- Konfiguracija projekta: `.Clisis Coder/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/Clisis Coder/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, Clisis Coder ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.Clisis Coder/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/Clisis Coder/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.Clisis Coder/skills/git-release/SKILL.md` ovako:
...
Clisis Coder navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `Clisis Coder.json`:
...
**Za ugradene agente** (u `Clisis Coder.json`):
