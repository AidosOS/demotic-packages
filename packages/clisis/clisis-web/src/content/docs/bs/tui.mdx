---
title: TUI
description: Korištenje korisničkog interfejsa Clisis Coder terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Clisis Coder pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Clisis Coder pokreće TUI za trenutni direktorij.
...
Kada koristite Clisis Coder TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Clisis Coder. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Clisis Coder. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `Clisis Coder.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Clisis Coder čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `Clisis Coder.default`.
