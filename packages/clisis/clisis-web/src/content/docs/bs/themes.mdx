...
U Clisis Coder mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, Clisis Coder koristi nasu `Clisis Coder` temu.
...
Clisis Coder dolazi sa vise ugradenih tema.
...
- Zele da Clisis Coder odgovara izgledu njihovog terminala
...
Clisis Coder podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
...
2. **Korisnicki config direktorij** - `~/.config/Clisis Coder/themes/*.json` ili `$XDG_CONFIG_HOME/Clisis Coder/themes/*.json`
3. **Korijenski direktorij projekta** - `<project-root>/.Clisis Coder/themes/*.json`
4. **Trenutni radni direktorij** - `./.Clisis Coder/themes/*.json`
