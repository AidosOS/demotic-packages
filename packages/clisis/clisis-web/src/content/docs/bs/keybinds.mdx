...
Clisis Coder ima listu veza tipki koje možete prilagoditi putem `tui.json`.
...
Clisis Coder koristi `leader` (vodeću) tipku za većinu povezivanja tipki. Ovo izbjegava sukobe u vašem terminalu.
...
Unos prompta aplikacije Clisis Coder za desktop podržava uobičajene prečice u stilu Readline/Emacs za uređivanje teksta. One su ugrađene i trenutno se ne mogu konfigurirati putem `Clisis Coder.json`.
