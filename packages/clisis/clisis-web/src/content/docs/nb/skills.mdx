...
Agentferdigheter lar Clisis Coder oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Clisis Coder søker etter disse stedene:

- Prosjektkonfigurasjon: `.Clisis Coder/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/Clisis Coder/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Clisis Coder opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.Clisis Coder/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/Clisis Coder/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.Clisis Coder/skills/git-release/SKILL.md` slik:
...
Clisis Coder viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `Clisis Coder.json`:
...
**For innebygde agenter** (i `Clisis Coder.json`):
