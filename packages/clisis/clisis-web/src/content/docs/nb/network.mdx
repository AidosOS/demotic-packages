...
Clisis Coder støtter standard proxy-miljøvariabler og tilpassede sertifikater for bedriftsnettverksmiljøer.
...
Hvis bedriften din bruker egendefinerte CA-er for HTTPS-tilkoblinger, konfigurer Clisis Coder til å stole på dem.
