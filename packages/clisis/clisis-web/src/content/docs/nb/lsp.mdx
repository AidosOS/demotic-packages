---
title: LSP-servere
description: Clisis Coder integreres med LSP-serverne dine.
---

Clisis Coder kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Clisis Coder kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `Clisis Coder_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og Clisis Coder åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Clisis Coder-konfigurasjonen.
