...
Clisis Coder har en liste over tastebindinger som du kan tilpasse gjennom `tui.json`.
...
Clisis Coder bruker en `leader`-tast for de fleste tastebindinger. Dette unngår konflikter i terminalen din.
...
Prompt-feltet for Clisis Coder-skrivebordsappen støtter vanlige snarveier i Readline/Emacs-stil for redigering av tekst. Disse er innebygd og foreløpig ikke konfigurerbare via `Clisis Coder.json`.
