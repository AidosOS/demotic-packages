---
title: TUI
description: Bruke Clisis Coder-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Clisis Coder gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Clisis Coder starter TUI for gjeldende katalog.
...
Når du bruker Clisis Coder TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Clisis Coder. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Clisis Coder. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `Clisis Coder.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Clisis Coder venter etter leader key. Standard er `2000`.
...
Bruk `Clisis Coder_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `Clisis Coder.default`.
