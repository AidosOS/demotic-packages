---
title: Zen
description: Utvalgt liste over modeller levert av Clisis Coder.
---
...
Clisis Coder Zen er en liste over testede og verifiserte modeller levert av Clisis Coder-teamet.

Zen fungerer som enhver annen leverandør i Clisis Coder. Du logger inn på Clisis Coder Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Clisis Coder.
:::
...
Clisis Coder Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Clisis Coder Zen fungerer som enhver annen leverandør i Clisis Coder.

1. Du logger inn på **<a href={console}>Clisis Coder Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Clisis Coder Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Clisis Coder-konfigurasjonen din
bruker formatet `Clisis Coder/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `Clisis Coder/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på Clisis Coder i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på Clisis Coder i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på Clisis Coder i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Clisis Coder i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet Clisis Coder Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Clisis Coder også.
