...
Opprett `.Clisis Coder/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Clisis Coder-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Clisis Coder [config](/docs/config):
...
- Per prosjekt: `.Clisis Coder/commands/`
...
Clisis Coder inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
