...
Det er to typer agenter i Clisis Coder; primære agenter og underagenter.
...
Clisis Coder kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Clisis Coder kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

Clisis Coder kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Konfigurer agenter i konfigurasjonsfilen `Clisis Coder.json`:
...
- Per prosjekt: `.Clisis Coder/agents/`
...
Hvis ingen temperatur er spesifisert, bruker Clisis Coder modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Clisis Coder-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Clisis Coder-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [Clisis Coder Zen](/docs/zen), vil du bruke `Clisis Coder/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `Clisis Coder models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/AidosOS/demotic-clisis-coder).
:::
