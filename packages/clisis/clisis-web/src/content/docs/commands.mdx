...
Create `.Clisis Coder/commands/test.md`:
...
You can add custom commands through the Clisis Coder config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Clisis Coder [config](/docs/config):
...
- Per-project: `.Clisis Coder/commands/`
...
Clisis Coder includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
