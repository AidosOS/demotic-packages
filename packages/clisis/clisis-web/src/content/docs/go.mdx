...
Clisis Coder Go is a low cost subscription — **$5 for your first month**, then **$10/month** — that gives you reliable access to popular open coding models.

Go works like any other provider in Clisis Coder. You subscribe to Clisis Coder Go and
...
Clisis Coder Go gives you access to these models for **$5 for your first month**, then **$10/month**.

---

## How it works

Clisis Coder Go works like any other provider in Clisis Coder.

1. You sign in to **<a href={console}>Clisis Coder Zen</a>**, subscribe to Go, and
   copy your API key.
2. You run the `/connect` command in the TUI, select `Clisis Coder Go`, and paste
   your API key.
3. Run `/models` in the TUI to see the list of models available through Go.

:::note
Only one member per workspace can subscribe to Clisis Coder Go.
:::
...
Clisis Coder Go includes the following limits:
...
uses the format `Clisis Coder-go/<model-id>`. For example, for Kimi K2.6, you would
use `Clisis Coder-go/kimi-k2.6` in your config.
...
4. Have **no lock-in** by allowing you to use any other provider with Clisis Coder as well.
