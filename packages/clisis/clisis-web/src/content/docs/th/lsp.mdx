...
description: Clisis Coder ทำงานร่วมกับเซิร์ฟเวอร์ LSP ของคุณ
---

Clisis Coder สามารถทำงานร่วมกับเซิร์ฟเวอร์ Language Server Protocol (LSP) เพื่อใช้ diagnostics เป็น feedback สำหรับ agent

---

## บิวท์อิน

Clisis Coder มาพร้อมกับเซิร์ฟเวอร์ LSP ในตัวหลายตัวสำหรับภาษายอดนิยม:
...
:::note
คุณสามารถปิดใช้งานการดาวน์โหลดเซิร์ฟเวอร์ LSP อัตโนมัติได้โดยตั้งค่าตัวแปรสภาพแวดล้อม `Clisis Coder_DISABLE_LSP_DOWNLOAD` เป็น `true`
:::
...
เมื่อเปิดใช้งาน LSP และ Clisis Coder เปิดไฟล์ มันจะ:
...
คุณสามารถเปิดใช้งานและปรับแต่งเซิร์ฟเวอร์ LSP ผ่านส่วน `lsp` ในการกำหนดค่า Clisis Coder
