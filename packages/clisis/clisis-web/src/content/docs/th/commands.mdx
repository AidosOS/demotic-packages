...
สร้าง `.Clisis Coder/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Clisis Coder:
...
- ระดับผู้ใช้ (Global): `~/.config/Clisis Coder/commands/`
- ระดับโปรเจ็กต์: `.Clisis Coder/commands/`
...
Clisis Coder มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
