...
Clisis Coder Go คือการสมัครสมาชิกในราคาประหยัด — **$5 สำหรับเดือนแรก** จากนั้น **$10/เดือน** — ซึ่งให้คุณเข้าถึงโมเดลโอเพนซอร์สยอดนิยมสำหรับการเขียนโค้ดได้อย่างเสถียร

Go ทำงานเหมือนกับผู้ให้บริการ (provider) รายอื่นๆ ใน Clisis Coder คุณสามารถสมัครสมาชิก Clisis Coder Go และรับ API key ของคุณ บริการนี้เป็น**ทางเลือกเพิ่มเติม** และคุณไม่จำเป็นต้องใช้มันเพื่อใช้งาน Clisis Coder
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่คัดเลือกมาเพื่อให้ทำงานร่วมกับ Clisis Coder ได้เป็นอย่างดี
:::
...
Clisis Coder Go ให้คุณเข้าถึงโมเดลเหล่านี้ได้ในราคา **$5 สำหรับเดือนแรก** จากนั้น **$10/เดือน**

---

## How it works

Clisis Coder Go ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน Clisis Coder

1. ลงชื่อเข้าใช้ที่ **<a href={console}>Clisis Coder Zen</a>**, สมัครสมาชิก Go และคัดลอก API key ของคุณ
2. รันคำสั่ง `/connect` ใน TUI, เลือก `Clisis Coder Go`, และวาง API key ของคุณ
3. รัน `/models` ใน TUI เพื่อดูรายชื่อโมเดลที่ใช้งานได้ผ่าน Go

:::note
มีเพียงสมาชิกหนึ่งคนต่อ workspace เท่านั้นที่สามารถสมัครสมาชิก Clisis Coder Go ได้
:::
...
Clisis Coder Go มีขีดจำกัดดังต่อไปนี้:
...
[model id](/docs/config/#models) ใน Clisis Coder config ของคุณจะใช้รูปแบบ `Clisis Coder-go/<model-id>` ตัวอย่างเช่น สำหรับ Kimi K2.6 คุณจะใช้ `Clisis Coder-go/kimi-k2.6` ใน config ของคุณ
...
เราสร้าง Clisis Coder Go เพื่อ:
...
4. **ไม่ผูกขาดการใช้งาน (no lock-in)** โดยอนุญาตให้คุณใช้งานผู้ให้บริการรายอื่นๆ ร่วมกับ Clisis Coder ได้เช่นกัน
