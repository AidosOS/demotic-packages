...
ทักษะของเจ้าหน้าที่ช่วยให้ Clisis Coder ค้นพบคำแนะนำที่ใช้ซ้ำได้จาก repo หรือโฮมไดเร็กทอรีของคุณ
...
Clisis Coder ค้นหาตำแหน่งเหล่านี้:

- การกำหนดค่าโครงการ: `.Clisis Coder/skills/<name>/SKILL.md`
- การกำหนดค่าส่วนกลาง: `~/.config/Clisis Coder/skills/<name>/SKILL.md`
...
สำหรับเส้นทางภายในโปรเจ็กต์ Clisis Coder จะเดินขึ้นมาจากไดเร็กทอรีการทำงานปัจจุบันของคุณจนกว่าจะถึงแผนผังงาน git
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.Clisis Coder/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง

คำจำกัดความสากลยังโหลดจาก `~/.config/Clisis Coder/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` และ `~/.agents/skills/*/SKILL.md`
...
สร้าง `.Clisis Coder/skills/git-release/SKILL.md` แบบนี้:
...
Clisis Coder แสดงรายการทักษะที่มีอยู่ในคำอธิบายเครื่องมือ `skill`
...
ควบคุมว่าตัวแทนทักษะใดสามารถเข้าถึงโดยใช้สิทธิ์ตามรูปแบบใน `Clisis Coder.json`:
...
**สำหรับตัวแทนในตัว** (ใน `Clisis Coder.json`):
