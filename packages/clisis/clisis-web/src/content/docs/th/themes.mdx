...
ด้วย Clisis Coder คุณสามารถเลือกจากหนึ่งในธีมที่มีอยู่แล้วภายใน ใช้ธีมที่ปรับให้เข้ากับธีม terminal ของคุณ หรือกำหนดธีมที่คุณกำหนดเองได้

ตามค่าเริ่มต้น Clisis Coder จะใช้ธีม `Clisis Coder` ของเราเอง
...
Clisis Coder มาพร้อมกับธีมในตัวหลายธีม
...
- ต้องการให้ Clisis Coder ตรงกับรูปลักษณ์ของ terminal
...
Clisis Coder รองรับระบบธีมที่ใช้ JSON ที่ยืดหยุ่น ซึ่งช่วยให้ผู้ใช้สามารถสร้างและปรับแต่งธีมได้อย่างง่ายดาย
...
2. **ไดเรกทอรีกำหนดค่าผู้ใช้** - กำหนดใน `~/.config/Clisis Coder/themes/*.json` หรือ `$XDG_CONFIG_HOME/Clisis Coder/themes/*.json`
3. **ไดเรกทอรีรากของโครงการ** - กำหนดไว้ใน `<project-root>/.Clisis Coder/themes/*.json`
4. **ไดเร็กทอรีการทำงานปัจจุบัน** - กำหนดใน `./.Clisis Coder/themes/*.json`
