---
title: TUI
description: Utilisation de l’interface utilisateur du terminal Clisis Coder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Clisis Coder fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de Clisis Coder démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le Clisis Coder TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à Clisis Coder. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez Clisis Coder. *Alias* : `/quit`, `/q`
...
Ceci est séparé de `Clisis Coder.json`, qui configure le comportement du serveur/d'exécution.
...
- `leader_timeout` - Contrôle la durée pendant laquelle Clisis Coder attend après la leader key. Valeur par défaut : `2000`.
...
- `sound_pack` - ID du sound pack à utiliser. Valeur par défaut : `Clisis Coder.default`.
