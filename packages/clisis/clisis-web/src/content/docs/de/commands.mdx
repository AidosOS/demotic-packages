...
Erstellen Sie `.Clisis Coder/commands/test.md`:

```md title=".Clisis Coder/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Clisis Coder-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Clisis Coder [config](/docs/config):

```json title="Clisis Coder.jsonc" {4-12}
{
...
- Global: `~/.config/Clisis Coder/commands/`
- Pro Projekt: `.Clisis Coder/commands/`

```markdown title="~/.config/Clisis Coder/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".Clisis Coder/commands/component.md"
---
...
```md title=".Clisis Coder/commands/create-file.md"
---
...
```md title=".Clisis Coder/commands/analyze-coverage.md"
---
...
```md title=".Clisis Coder/commands/review-changes.md"
---
...
```md title=".Clisis Coder/commands/review-component.md"
---
...
Clisis Coder enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
