...
Mit Clisis Coder kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Clisis Coder das `Clisis Coder`-Theme.
...
Clisis Coder liefert mehrere eingebaute Themes mit.
...
- Clisis Coder optisch ans Terminal anpassen wollen
...
Clisis Coder unterstuetzt ein flexibles JSON-basiertes Theme-System.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/Clisis Coder/themes/*.json` oder `$XDG_CONFIG_HOME/Clisis Coder/themes/*.json`
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.Clisis Coder/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.Clisis Coder/themes/*.json`
