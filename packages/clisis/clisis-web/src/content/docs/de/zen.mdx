---
title: Zen
description: Kuratierte Modellliste direkt von Clisis Coder.
---
...
Clisis Coder Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Clisis Coder-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Clisis Coder. Du meldest dich bei Clisis Coder Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Clisis Coder zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Clisis Coder funktionieren.
:::
...
Clisis Coder Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Clisis Coder Zen funktioniert wie jeder andere Provider in Clisis Coder.

1. Du meldest dich bei **<a href={console}>Clisis Coder Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Clisis Coder Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Clisis Coder-Konfiguration verwendet das Format `Clisis Coder/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `Clisis Coder/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf Clisis Coder verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf Clisis Coder verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Clisis Coder verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Clisis Coder verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Clisis Coder Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Clisis Coder auch jeden anderen Provider zu verwenden.
