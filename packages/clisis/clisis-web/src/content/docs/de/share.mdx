---
title: Teilen
description: Teile Clisis Coder-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Clisis Coder-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Clisis Coder Folgendes:
...
Clisis Coder hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Clisis Coder den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`Clisis Coder.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du Clisis Coder in deiner Organisation einsetzt.
