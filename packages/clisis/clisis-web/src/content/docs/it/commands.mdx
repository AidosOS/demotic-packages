...
Crea `.Clisis Coder/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Clisis Coder o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Clisis Coder:
...
- Globale: `~/.config/Clisis Coder/commands/`
- Per progetto: `.Clisis Coder/commands/`
...
Clisis Coder include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
