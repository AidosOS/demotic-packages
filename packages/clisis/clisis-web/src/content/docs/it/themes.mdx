...
Con Clisis Coder puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminale oppure definire un tema personalizzato.

Per impostazione predefinita, Clisis Coder usa il tema `Clisis Coder`.
...
Clisis Coder include diversi temi integrati.
...
- Vuole che Clisis Coder corrisponda all'aspetto del terminale
...
Clisis Coder supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.
...
2. **Directory di configurazione utente** - in `~/.config/Clisis Coder/themes/*.json` o `$XDG_CONFIG_HOME/Clisis Coder/themes/*.json`
3. **Directory root del progetto** - in `<project-root>/.Clisis Coder/themes/*.json`
4. **Directory di lavoro corrente** - in `./.Clisis Coder/themes/*.json`
