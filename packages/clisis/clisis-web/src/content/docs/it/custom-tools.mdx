...
description: Crea strumenti che l'LLM puo chiamare in Clisis Coder.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di Clisis Coder come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.Clisis Coder/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/Clisis Coder/tools/`.
