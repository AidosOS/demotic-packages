...
Clisis Coder supporta le variabili d'ambiente standard per i proxy e certificati personalizzati per ambienti di rete enterprise.

---

## Proxy

Clisis Coder rispetta le variabili d'ambiente standard dei proxy.
...
Se la tua organizzazione usa CA personalizzate per connessioni HTTPS, configura Clisis Coder in modo che si fidi di esse.
