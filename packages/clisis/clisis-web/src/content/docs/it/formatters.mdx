---
title: Formattatori
description: Clisis Coder usa formattatori specifici per linguaggio.
---

Clisis Coder formatta automaticamente i file dopo che vengono scritti o modificati usando formattatori specifici per linguaggio. Questo assicura che il codice generato segua lo stile del tuo progetto.

---

## Integrati

Clisis Coder include diversi formattatori integrati per linguaggi e framework popolari. Qui sotto trovi la lista dei formattatori, delle estensioni supportate e dei comandi o opzioni di config richiesti.
...
Quindi, se il progetto ha `prettier` in `package.json`, Clisis Coder lo usera automaticamente.

---

## Come funziona

Quando Clisis Coder scrive o modifica un file:
...
Puoi personalizzare i formattatori nella sezione `formatter` della config di Clisis Coder.
