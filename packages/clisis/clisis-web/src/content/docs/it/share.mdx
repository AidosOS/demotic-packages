---
title: Condivisione
description: Condividi le tue conversazioni Clisis Coder.
---

La funzione di condivisione di Clisis Coder ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Clisis Coder:
...
Clisis Coder supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Clisis Coder usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `Clisis Coder.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare Clisis Coder nella tua organizzazione.
