...
Le skill degli agenti permettono a Clisis Coder di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
Clisis Coder cerca in queste posizioni:

- Config di progetto: `.Clisis Coder/skills/<name>/SKILL.md`
- Config globale: `~/.config/Clisis Coder/skills/<name>/SKILL.md`
...
Per i percorsi locali al progetto, Clisis Coder risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
Carica qualsiasi `skills/*/SKILL.md` corrispondente in `.Clisis Coder/` e qualsiasi `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` corrispondente lungo il percorso.

Le definizioni globali vengono caricate anche da `~/.config/Clisis Coder/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` e `~/.agents/skills/*/SKILL.md`.
...
Crea `.Clisis Coder/skills/git-release/SKILL.md` cosi':
...
Clisis Coder elenca le skill disponibili nella descrizione dello strumento `skill`.
...
Controlla a quali skill gli agenti possono accedere usando permessi basati su pattern in `Clisis Coder.json`:
...
**Per agenti integrati** (in `Clisis Coder.json`):
