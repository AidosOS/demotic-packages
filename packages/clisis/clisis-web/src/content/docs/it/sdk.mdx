---
title: SDK
description: Client JS type-safe per il server Clisis Coder.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

L'SDK JS/TS di Clisis Coder fornisce un client type-safe per interagire con il server.
Usalo per creare integrazioni e controllare Clisis Coder in modo programmatico.
...
Crea un'istanza di Clisis Coder:
...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `Clisis Coder.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
...
Se hai gia un'istanza di Clisis Coder in esecuzione, puoi creare un client per collegarti:
