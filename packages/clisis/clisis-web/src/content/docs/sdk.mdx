---
title: SDK
description: Type-safe JS client for Clisis Coder server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The Clisis Coder JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control Clisis Coder programmatically.
...
Create an instance of Clisis Coder:
...
You can pass a configuration object to customize behavior. The instance still picks up your `Clisis Coder.json`, but you can override or add configuration inline:
...
If you already have a running instance of Clisis Coder, you can create a client instance to connect to it:
