---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Clisis Coder.
---
...
Clisis Coder Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Clisis Coder.

Zen działa jak każdy inny dostawca w Clisis Coder. Logujesz się do Clisis Coder Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Clisis Coder.
:::
...
Clisis Coder Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Clisis Coder Zen działa jak każdy inny dostawca w Clisis Coder.

1. Logujesz się do **<a href={console}>Clisis Coder Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Clisis Coder Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Clisis Coder używa formatu
`Clisis Coder/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`Clisis Coder/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w Clisis Coder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w Clisis Coder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Clisis Coder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Clisis Coder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy Clisis Coder Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Clisis Coder także dowolnego innego dostawcy.
