...
Utwórz `.Clisis Coder/commands/test.md`:
...
Możesz zdefiniować polecenia w `Clisis Coder.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji Clisis Coder:
...
- Globalnie: `~/.config/Clisis Coder/commands/`
- Na projekt: `.Clisis Coder/commands/`
...
Clisis Coder zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
