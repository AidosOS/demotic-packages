---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące Clisis Coder.
---

Funkcja udostępniania Clisis Coder umożliwia tworzenie publicznych linków do konwersacji Clisis Coder, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, Clisis Coder:
...
Clisis Coder obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie Clisis Coder korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `Clisis Coder.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu Clisis Coder w Twojej organizacji.
