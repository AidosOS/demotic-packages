...
أنشئ الملف `.Clisis Coder/commands/test.md`:
...
يمكنك إضافة أوامر مخصصة عبر إعدادات Clisis Coder أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ Clisis Coder:
...
- على مستوى النظام: `~/.config/Clisis Coder/commands/`
- لكل مشروع: `.Clisis Coder/commands/`
...
يتضمن Clisis Coder عدة أوامر مضمنة مثل `/init` و`/undo` و`/redo` و`/share` و`/help`؛ [اعرف المزيد](/docs/tui#commands).
