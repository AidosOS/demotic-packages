---
title: TUI
description: استخدام واجهة المستخدم TUI في Clisis Coder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Clisis Coder واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Clisis Coder إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Clisis Coder في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Clisis Coder. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Clisis Coder. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `Clisis Coder.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Clisis Coder بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `Clisis Coder.default`.
