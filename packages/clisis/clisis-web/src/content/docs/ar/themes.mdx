...
مع Clisis Coder يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم Clisis Coder سمتنا `Clisis Coder`.
...
يأتي Clisis Coder مع عدة سمات مدمجة.
...
- يريدون أن يطابق Clisis Coder مظهر terminal لديهم
...
يدعم Clisis Coder نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/Clisis Coder/themes/*.json` أو `$XDG_CONFIG_HOME/Clisis Coder/themes/*.json`
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.Clisis Coder/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.Clisis Coder/themes/*.json`
