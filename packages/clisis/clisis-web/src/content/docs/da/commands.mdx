...
Opret `.Clisis Coder/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Clisis Coder-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Clisis Coder [config](/docs/config):
...
- Globalt: `~/.config/Clisis Coder/commands/`
- Pr. projekt: `.Clisis Coder/commands/`
...
Clisis Coder indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
