---
title: Zen
description: Udvalgt liste over modeller leveret af Clisis Coder.
---
...
Clisis Coder Zen er en liste over testede og verificerede modeller leveret af Clisis Coder-teamet.

Zen fungerer som enhver anden udbyder i Clisis Coder. Du logger ind på Clisis Coder Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Clisis Coder.
:::
...
Clisis Coder Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Clisis Coder Zen fungerer som enhver anden udbyder i Clisis Coder.

1. Du logger ind på **<a href={console}>Clisis Coder Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Clisis Coder Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din Clisis Coder-konfiguration
bruger formatet `Clisis Coder/<model-id>`. For eksempel ville du for GPT 5.5
bruge `Clisis Coder/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på Clisis Coder i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på Clisis Coder i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på Clisis Coder i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Clisis Coder i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
Vi skabte Clisis Coder Zen for at:
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Clisis Coder også.
