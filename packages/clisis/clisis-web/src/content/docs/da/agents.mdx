...
Der er to typer agenter i Clisis Coder; primære agenter og subagenter.
...
Clisis Coder leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Clisis Coder leveres med tre indbyggede subagenter, **General**, **Explore** og **Scout**. Vi ser nærmere på dem nedenfor.

---

## Indbyggede

Clisis Coder leveres med to indbyggede primære agenter og tre indbyggede subagenter.
...
En skrivebeskyttet agent til eksterne docs og research af dependencies. Brug denne, når du har brug for at klone et dependency-repository ind i Clisis Coder's administrerede cache, inspicere kildekoden i et bibliotek eller krydstjekke lokal kode mod upstream-implementeringer uden at ændre dit workspace.
...
Konfigurer agent i din `Clisis Coder.json`-konfigurationsfil:
...
- Globalt: `~/.config/Clisis Coder/agents/`
- Pr. projekt: `.Clisis Coder/agents/`
...
Hvis ingen temperatur er angivet, bruger Clisis Coder modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Clisis Coder-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Clisis Coder-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Clisis Coder Zen](/docs/zen), vil du bruge `Clisis Coder/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `Clisis Coder models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/AidosOS/demotic-clisis-coder).
:::
