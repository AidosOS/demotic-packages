...
Her er alle de innebygde verktøyene som er tilgængelige i Clisis Coder.
...
:::note
Dette verktøyet er bare tilgængelig når `Clisis Coder_EXPERIMENTAL_LSP_TOOL=true` (eller `Clisis Coder_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Clisis Coder-leverandøren eller når miljøvariabelen `Clisis Coder_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
