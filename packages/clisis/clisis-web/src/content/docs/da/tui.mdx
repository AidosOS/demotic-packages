---
title: TUI
description: Brug af Clisis Coder-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Clisis Coder giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Clisis Coder starter TUI for den nuværende mappe.
...
Når du bruger Clisis Coder TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Clisis Coder. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Clisis Coder. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `Clisis Coder.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Clisis Coder venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `Clisis Coder.default`.
