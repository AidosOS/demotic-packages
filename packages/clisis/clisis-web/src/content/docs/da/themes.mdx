...
Med Clisis Coder kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger Clisis Coder vårt eget `Clisis Coder`-tema.
...
Clisis Coder kommer med flere innebygde temaer.
...
- Vil at Clisis Coder skal matche terminalens utseende
...
Clisis Coder støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
...
2. **Brugerkonfigurasjonskatalog** - Definert i `~/.config/Clisis Coder/themes/*.json` eller `$XDG_CONFIG_HOME/Clisis Coder/themes/*.json`
3. **Prosjektrotkatalog** - Definert i `<project-root>/.Clisis Coder/themes/*.json`
4. **Nuværende arbejdskatalog** - Definert i `./.Clisis Coder/themes/*.json`
