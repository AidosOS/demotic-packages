...
Clisis Coder Go er et lavprisabonnement — **$5 for din første måned**, derefter **$10/måned** — der giver dig pålidelig adgang til populære åbne kodningsmodeller.

Go fungerer som enhver anden udbyder i Clisis Coder. Du abonnerer på Clisis Coder Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med Clisis Coder.
:::
...
Clisis Coder Go giver dig adgang til disse modeller for **$5 for din første måned**, derefter **$10/måned**.

---

## Sådan fungerer det

Clisis Coder Go fungerer som enhver anden udbyder i Clisis Coder.

1. Du logger ind på **<a href={console}>Clisis Coder Zen</a>**, abonnerer på Go, og
   kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `Clisis Coder Go`, og indsætter
   din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over tilgængelige modeller gennem Go.

:::note
Kun ét medlem per arbejdsområde kan abonnere på Clisis Coder Go.
:::
...
Clisis Coder Go inkluderer følgende grænser:
...
Dit [model id](/docs/config/#models) i din Clisis Coder config
bruger formatet `Clisis Coder-go/<model-id>`. For eksempel for Kimi K2.6, vil du
bruge `Clisis Coder-go/kimi-k2.6` i din config.
...
Vi skabte Clisis Coder Go for at:
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med Clisis Coder.
