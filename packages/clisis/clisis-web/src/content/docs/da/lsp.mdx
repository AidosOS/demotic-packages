---
title: LSP-servere
description: Clisis Coder integreres med dine LSP-servere.
---

Clisis Coder kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Clisis Coder leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `Clisis Coder_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og Clisis Coder åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din Clisis Coder-konfiguration.
