...
`.Clisis Coder/commands/test.md` を作成します。
...
カスタムコマンドは、Clisis Coder 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

Clisis Coder [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/Clisis Coder/commands/`
- プロジェクトごと: `.Clisis Coder/commands/`
...
Clisis Coder には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
