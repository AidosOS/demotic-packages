...
Clisis Coder は、エンタープライズネットワーク環境の標準プロキシ環境変数とカスタム証明書をサポートしています。

---

## プロキシ

Clisis Coder は標準のプロキシ環境変数を尊重します。
...
企業が HTTPS 接続にカスタム CA を使用している場合は、それらを信頼するように Clisis Coder を構成します。
