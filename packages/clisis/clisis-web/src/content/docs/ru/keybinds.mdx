...
Clisis Coder имеет список сочетаний клавиш, которые вы можете настроить через `tui.json`.
...
Clisis Coder использует клавишу `leader` для большинства сочетаний клавиш. Это позволяет избежать конфликтов в вашем терминале.
...
Ввод приглашения настольного приложения Clisis Coder поддерживает распространенные сочетания клавиш в стиле Readline/Emacs для редактирования текста. Они встроены и в настоящее время не настраиваются через `Clisis Coder.json`.
