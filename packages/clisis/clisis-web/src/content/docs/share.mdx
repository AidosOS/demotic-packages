---
title: Share
description: Share your Clisis Coder conversations.
---

Clisis Coder's share feature allows you to create public links to your Clisis Coder conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Clisis Coder:
...
Clisis Coder supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Clisis Coder uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `Clisis Coder.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using Clisis Coder in your organization.
