---
title: Compartilhar
description: Compartilhe suas conversas do Clisis Coder.
---

O recurso de compartilhamento do Clisis Coder permite que você crie links públicos para suas conversas do Clisis Coder, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o Clisis Coder:
...
O Clisis Coder suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o Clisis Coder usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `Clisis Coder.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o Clisis Coder em sua organização.
