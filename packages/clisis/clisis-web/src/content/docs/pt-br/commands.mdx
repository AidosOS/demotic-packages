...
Crie `.Clisis Coder/commands/test.md`:
...
Você pode adicionar comandos personalizados através da configuração do Clisis Coder ou criando arquivos markdown no diretório `commands/`.

---

### JSON

Use a opção `command` na sua [configuração](/docs/config) do Clisis Coder:
...
- Por projeto: `.Clisis Coder/commands/`
...
Clisis Coder inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
