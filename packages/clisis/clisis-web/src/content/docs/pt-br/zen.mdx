---
title: Zen
description: Lista selecionada de modelos fornecidos pelo Clisis Coder.
---
...
O Clisis Coder Zen é uma lista de modelos testados e verificados fornecidos pela equipe do Clisis Coder.

O Zen funciona como qualquer outro provedor no Clisis Coder. Você faz login no Clisis Coder Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o Clisis Coder.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o Clisis Coder.
:::
...
O Clisis Coder Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O Clisis Coder Zen funciona como qualquer outro provedor no Clisis Coder.

1. Você faz login no **<a href={console}>Clisis Coder Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Clisis Coder Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do Clisis Coder usa o formato `Clisis Coder/<model-id>`. Por exemplo, para GPT 5.5, você usaria `Clisis Coder/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no Clisis Coder por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no Clisis Coder por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no Clisis Coder por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no Clisis Coder por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
Criamos o Clisis Coder Zen para:
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o Clisis Coder também.
