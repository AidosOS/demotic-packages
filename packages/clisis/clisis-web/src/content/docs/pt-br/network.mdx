...
O Clisis Coder suporta variáveis de ambiente de proxy padrão e certificados personalizados para ambientes de rede corporativa.

---

## Proxy

O Clisis Coder respeita variáveis de ambiente de proxy padrão.
...
Se sua empresa usa CAs personalizadas para conexões HTTPS, configure o Clisis Coder para confiá-las.
