---
title: Compartir
description: Comparte tus conversaciones Clisis Coder.
---

La función para compartir de Clisis Coder te permite crear enlaces públicos a tus conversaciones de Clisis Coder, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Clisis Coder:
...
Clisis Coder admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Clisis Coder usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `Clisis Coder.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de Clisis Coder en su organización.
