...
Crear `.Clisis Coder/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Clisis Coder o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Clisis Coder [config](/docs/config):
...
- Por proyecto: `.Clisis Coder/commands/`
...
Clisis Coder incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
