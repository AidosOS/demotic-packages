---
title: TUI
description: Usando la interfaz de usuario del terminal Clisis Coder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Clisis Coder proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Clisis Coder se inicia TUI para el directorio actual.
...
Cuando utilice Clisis Coder TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Clisis Coder. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Clisis Coder. _Alias_: `/quit`, `/q`
...
Esto es independiente de `Clisis Coder.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera Clisis Coder después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `Clisis Coder.default`.
