---
title: Servidor
description: Interactuar con el servidor Clisis Coder a través de HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El comando `Clisis Coder serve` ejecuta un servidor HTTP sin cabeza que expone un punto final OpenAPI que un cliente Clisis Coder puede usar.
...
| `--mdns-domain` | Nombre de dominio personalizado para el servicio mDNS | `Clisis Coder.local` |
...
Configure `Clisis Coder_SERVER_PASSWORD` para proteger el servidor con autenticación básica HTTP. El nombre de usuario predeterminado es `Clisis Coder`, o configure `Clisis Coder_SERVER_USERNAME` para anularlo. Esto se aplica tanto a `Clisis Coder serve` como a `Clisis Coder web`.
...
Cuando ejecuta `Clisis Coder`, inicia un TUI y un servidor. Donde el TUI es el
...
:::tip
Utilice el servidor Clisis Coder para interactuar con Clisis Coder mediante programación.
:::

Esta arquitectura permite que Clisis Coder admita múltiples clientes y le permite interactuar con Clisis Coder mediante programación.

Puede ejecutar `Clisis Coder serve` para iniciar un servidor independiente. Si tienes el
Clisis Coder TUI ejecutándose, `Clisis Coder serve` iniciará un nuevo servidor.
...
El punto final [`/tui`](#tui) se puede utilizar para conducir el TUI a través del servidor. Por ejemplo, puede completar previamente o ejecutar un mensaje. Esta configuración es utilizada por los complementos Clisis Coder [IDE](/docs/ide).
...
El servidor Clisis Coder expone las siguientes API.
