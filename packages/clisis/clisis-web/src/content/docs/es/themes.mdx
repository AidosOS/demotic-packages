...
Con Clisis Coder puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Clisis Coder usa nuestro propio tema `Clisis Coder`.
...
Clisis Coder viene con varios temas integrados.
...
- Quiere que Clisis Coder coincida con la apariencia de su terminal
...
Clisis Coder admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/Clisis Coder/themes/*.json` o `$XDG_CONFIG_HOME/Clisis Coder/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.Clisis Coder/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.Clisis Coder/themes/*.json`
