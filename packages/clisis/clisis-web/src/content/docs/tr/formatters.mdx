...
description: Clisis Coder dile özgü biçimlendiriciler kullanır.
---

Clisis Coder, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

Clisis Coder, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, Clisis Coder bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

Clisis Coder bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri Clisis Coder yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
