...
Ajan becerileri, Clisis Coder'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
Clisis Coder su konumlari tarar:

- Proje konfigurasyonu: `.Clisis Coder/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/Clisis Coder/skills/<name>/SKILL.md`
...
Proje yerel yollarinda Clisis Coder, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.Clisis Coder/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/Clisis Coder/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.Clisis Coder/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
Clisis Coder, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`Clisis Coder.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`Clisis Coder.json` icinde):
