...
`.Clisis Coder/commands/test.md` oluştur:
...
Clisis Coder işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

Clisis Coder [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/Clisis Coder/commands/`
- Proje başına: `.Clisis Coder/commands/`
...
Clisis Coder, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
