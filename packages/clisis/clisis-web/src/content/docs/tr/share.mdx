---
title: Paylasim
description: Clisis Coder konusmalarini genel baglantilarla paylasin.
---

Clisis Coder'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda Clisis Coder:
...
Clisis Coder, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak Clisis Coder manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `Clisis Coder.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda Clisis Coder kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
