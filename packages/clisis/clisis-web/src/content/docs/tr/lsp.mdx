...
description: Clisis Coder, LSP sunucularınızla bütünleşir.
---

Clisis Coder, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

Clisis Coder, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`Clisis Coder_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
...
LSP etkinleştirildiğinde ve Clisis Coder bir dosyayı açtığında:
...
LSP sunucularını, Clisis Coder yapılandırmanızdaki `lsp` bölümü aracılığıyla etkinleştirebilir ve özelleştirebilirsiniz.
