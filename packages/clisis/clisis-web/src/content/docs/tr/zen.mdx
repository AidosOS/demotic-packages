---
title: Zen
description: Clisis Coder tarafından sağlanan seçilmiş modeller listesi.
---
...
Clisis Coder Zen, Clisis Coder ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Clisis Coder'daki diğer sağlayıcılar gibi çalışır. Clisis Coder Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Clisis Coder kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Clisis Coder ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Clisis Coder Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Clisis Coder Zen, Clisis Coder'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Clisis Coder Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Clisis Coder Zen'i seçin ve API anahtarınızı yapıştırın.
...
Clisis Coder yapılandırmanızdaki [model id](/docs/config/#models) `Clisis Coder/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `Clisis Coder/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Clisis Coder'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Clisis Coder'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Clisis Coder'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Clisis Coder'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Clisis Coder Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Clisis Coder ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
