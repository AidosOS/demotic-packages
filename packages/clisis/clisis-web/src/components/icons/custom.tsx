...
export function IconClisis(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M23.5 17L14.5 37L23.5 57" stroke="currentColor" stroke-width="5.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M46.5 17L55.5 37L46.5 57" stroke="currentColor" stroke-width="5.5" stroke-linecap="round" stroke-linejoin="round"/>
      <rect x="28.5" y="27" width="13" height="16" rx="3" fill="currentColor" fill-opacity="0.25"/>
    </svg>
  )
}
