...
import { IconClisis } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "clisisCoder/session/message-v2"
import type { Message } from "clisisCoder/session/message"
import type { Session } from "clisisCoder/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.clisis_coder_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.clisis_coder_name}>
                    <IconClisis width={16} height={16} />
                  </div>
