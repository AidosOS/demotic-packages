...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-LLM/RequestExecutor") {}
...
// list. `SHORT_QUERY_NAME` covers anchored short keys like `?key=â€¦` / `?sig=â€¦`
