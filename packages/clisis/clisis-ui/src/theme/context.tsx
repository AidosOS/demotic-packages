...
const STORAGE_KEYS = {
  THEME_ID: "ClisisCoder-theme-id",
  COLOR_SCHEME: "ClisisCoder-color-scheme",
  THEME_CSS_LIGHT: "ClisisCoder-theme-css-light",
  THEME_CSS_DARK: "ClisisCoder-theme-css-dark",
} as const
...
const names: Record<string, string> = {
  ...
  clisisCoder: "clisisCoder",
  "demotic-blue": "Demotic Blue",
  orng: "Orng",
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string; onThemeApplied?: (theme: DesktopTheme, mode: "light" | "dark") => void }) => {
    const themeId = normalize(read(STORAGE_KEYS.THEME_ID) ?? props.defaultTheme) ?? "demotic-blue"
    ...
    onMount(() => {
      ...
      const savedTheme = normalize(rawTheme ?? props.defaultTheme) ?? "demotic-blue"
