...
declare const CLISIS_CODER_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CLISIS_CODER_LIBC === "undefined" ? undefined : CLISIS_CODER_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CLISIS_CODER_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.CLISIS_CODER_EXPERIMENTAL_FILEWATCHER) {
