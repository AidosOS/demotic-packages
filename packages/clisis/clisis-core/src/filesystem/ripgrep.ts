...
import { sanitizedProcessEnv } from "../util/clisis-coder-process"
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".clisis-coder")) continue
