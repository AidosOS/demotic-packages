...
export class RequestContextRef extends Context.Service<RequestContextRef, RequestContext>()(
  "@demotic/clisis-example/RequestContextRef",
) {}
...
export class ConfigService extends Context.Service<ConfigService, ConfigServiceShape>()(
  "@demotic/clisis-example/ConfigService",
) {}
...
export class ConfigServiceMap extends LayerMap.Service<ConfigServiceMap>()("@demotic/clisis-example/ConfigServiceMap", {
