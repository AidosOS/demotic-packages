...
import { ensureProcessMetadata } from "../util/clisis-coder-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    serviceName: "clisisCoder",
    serviceVersion: InstallationVersion,
    attributes: {
      ...attributes,
      "deployment.environment.name": InstallationChannel,
      "clisis-coder.client": Flag.CLISIS_CODER_CLIENT,
      "clisis-coder.process_role": processMetadata.processRole,
      "clisis-coder.run_id": processMetadata.runID,
