...
/** Intentional public native API for Effect applications embedding ClisisCoder. */
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-public/clisisCoder") {}
...
>()("@demotic/clisis-public/clisisCoder/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("clisis-coder.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("clisis-coder.sessions.switchModel")(function* (input) {
...
// TODO: Add ClisisCoder.create(...) as the Promise facade over the same native API semantics.
