...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-ProjectReference") {}
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (!Flag.CLISIS_CODER_EXPERIMENTAL_REFERENCES) return Service.of(inert)
