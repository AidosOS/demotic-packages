...
export class ConfigService extends Context.Service<ConfigService, Config>()("@demotic/clisis-v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.CLISIS_CODER_WEBSEARCH_PROVIDER === "exa" || process.env.CLISIS_CODER_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.CLISIS_CODER_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("CLISIS_CODER_EXPERIMENTAL") || truthy("CLISIS_CODER_ENABLE_EXA") || truthy("CLISIS_CODER_EXPERIMENTAL_EXA"),
    enableParallel: truthy("CLISIS_CODER_ENABLE_PARALLEL") || truthy("CLISIS_CODER_EXPERIMENTAL_PARALLEL"),
              ...
              const text =
                provider === "exa"
                  ...
                  : yield* callMcp(
                      ...
                      {
                        "User-Agent": `clisisCoder/${InstallationVersion}`,
