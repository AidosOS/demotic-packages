...
import {
  ...
  type LLMClientShape,
  type LLMRequest,
} from "@demotic/clisis-llm"
import * as OpenAIChat from "@demotic/clisis-llm/protocols/openai-chat"
import { Database } from "@demotic/clisis-core/database/database"
import { EventV2 } from "@demotic/clisis-core/event"
import { PermissionV2 } from "@demotic/clisis-core/permission"
import { EventTable } from "@demotic/clisis-core/event/sql"
import { Project } from "@demotic/clisis-core/project"
import { ProjectTable } from "@demotic/clisis-core/project/sql"
import { QuestionV2 } from "@demotic/clisis-core/question"
import { AbsolutePath } from "@demotic/clisis-core/schema"
import { SessionV2 } from "@demotic/clisis-core/session"
import { ContextSnapshotDecodeError } from "@demotic/clisis-core/session/error"
import { SessionEvent } from "@demotic/clisis-core/session/event"
import { SessionInput } from "@demotic/clisis-core/session/input"
import { SessionMessage } from "@demotic/clisis-core/session/message"
import { Prompt } from "@demotic/clisis-core/session/prompt"
import { SessionProjector } from "@demotic/clisis-core/session/projector"
import { SessionExecution } from "@demotic/clisis-core/session/execution"
import { SessionContextEpoch } from "@demotic/clisis-core/session/context-epoch"
import { SessionRunCoordinator } from "@demotic/clisis-core/session/run-coordinator"
import { SessionRunner } from "@demotic/clisis-core/session/runner"
import * as SessionRunnerLLM from "@demotic/clisis-core/session/runner/llm"
import { SessionRunnerModel } from "@demotic/clisis-core/session/runner/model"
import { ToolRegistry } from "@demotic/clisis-core/tool/registry"
import { ToolOutputStore } from "@demotic/clisis-core/tool-output-store"
import { ApplicationTools } from "@demotic/clisis-core/tool/application-tools"
import { AgentV2 } from "@demotic/clisis-core/agent"
import { Config } from "@demotic/clisis-core/config"
import { ConfigCompaction } from "@demotic/clisis-core/config/compaction"
import { Tool } from "@demotic/clisis-core/tool/tool"
import {
  SessionContextEpochTable,
  SessionInputTable,
  SessionMessageTable,
  SessionTable,
} from "@demotic/clisis-core/session/sql"
import { SessionStore } from "@demotic/clisis-core/session/store"
import { SystemContext } from "@demotic/clisis-core/system-context"
import { SystemContextRegistry } from "@demotic/clisis-core/system-context/registry"
import { SkillGuidance } from "@demotic/clisis-core/skill/guidance"
