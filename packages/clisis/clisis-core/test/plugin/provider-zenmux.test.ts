...
import { ProviderPlugins } from "@demotic/clisis-core/plugin/provider"
import { ZenmuxPlugin } from "@demotic/clisis-core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://clisiscoder.ai/", "X-Title": "clisisCoder" })
