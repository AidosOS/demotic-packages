import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@demotic/clisis-core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
