...
import { Keybind } from "@demotic/clisis-ui/keybind"
...
export function SessionHeader() {
  ...
  onMount(() => {
    setCenterMount(document.getElementById("ClisisCoder-titlebar-center"))
    setRightMount(document.getElementById("ClisisCoder-titlebar-right"))
  })
