...
import { List, type ListRef } from "@demotic/clisis-ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "clisisCoder"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.clisisCoderZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.clisisCoderZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.clisisCoderZen.visit.prefix")}
                <Link href="https://clisiscoder.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.clisisCoderZen.visit.link")}
                </Link>
                {language.t("provider.connect.clisisCoderZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
