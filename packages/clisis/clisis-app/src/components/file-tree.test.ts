...
beforeAll(async () => {
  ...
  mock.module("@demotic/clisis-ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@demotic/clisis-ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@demotic/clisis-ui/icon", () => ({ Icon: () => null }))
  mock.module("@demotic/clisis-ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
