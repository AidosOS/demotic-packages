...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "clisisCoder Documentation", href: "https://clisiscoder.ai/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/clisisCoder" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/AidosOS/demotic-clisis-coder/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/AidosOS/demotic-clisis-coder/issues/new?template=bug_report.yml",
      },
    ],
  },
]
