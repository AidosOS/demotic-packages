...
export const dict = {
  ...
  "dialog.provider.clisis-coder.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.clisis-coder.tagline": "PÃ¥litelige, optimaliserte modeller",
  "dialog.provider.clisisCoderGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av clisisCoder",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nÃ¸kkel for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i ClisisCoder.",
  ...
  "provider.connect.clisisCoderZen.line1":
    "clisisCoder Zen gir deg tilgang til et utvalg av pÃ¥litelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for Ã¥ hente autorisasjonskoden din for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i ClisisCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i ClisisCoder.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i clisiscoder.json",
  ...
  "dialog.server.description": "Bytt hvilken ClisisCoder-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av clisisCoder ({{version}}) er nÃ¥ tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til ClisisCoder-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandÃ¸r-/modellnavnene i konfigurasjonen din (clisiscoder.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at clisisCoder ikke stÃ¸tter MCP-autentisering ennÃ¥.',
  ...
  "sidebar.gettingStarted.line1": "clisisCoder inkluderer gratis modeller sÃ¥ du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "KjÃ¸r ClisisCoder-serveren i WSL pÃ¥ Windows.",
  ...
  "settings.general.row.language.description": "Endre visningssprÃ¥ket for clisisCoder",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan clisisCoder ser ut pÃ¥ enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om clisisCoder skal fÃ¸lge systemets, lyst eller mÃ¸rkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan clisisCoder er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer nÃ¥r clisisCoder starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av ClisisCoder.",
