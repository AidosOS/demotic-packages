export const dict = {
  ...
  "dialog.provider.clisis-coder.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.clisis-coder.tagline": "Reliable optimized models",
  "dialog.provider.clisisCoderGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by clisisCoder",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in ClisisCoder.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.clisisCoderZen.line1":
    "clisisCoder Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.clisisCoderZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.clisisCoderZen.visit.prefix": "Visit ",
  "provider.connect.clisisCoderZen.visit.link": "clisis-coder.ai/zen",
  "provider.connect.clisisCoderZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in ClisisCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in ClisisCoder.",
  ...
  "dialog.plugins.empty": "Plugins configured in clisiscoder.json",
  ...
  "dialog.server.description": "Switch which clisisCoder server this app connects to.",
  ...
  "wsl.onboarding.step.clisis-coder": "clisisCoder",
  ...
  "wsl.onboarding.checkingClisisCoder": "Checking ClisisCoder...",
  "wsl.onboarding.checkingclisisCoderIn": "Checking clisisCoder in {{distro}}...",
  "wsl.onboarding.updatingClisisCoder": "Updating ClisisCoder...",
  "wsl.onboarding.updatingclisisCoderIn": "Updating clisisCoder in {{distro}}...",
  "wsl.onboarding.updateclisisCoderIn": "Update clisisCoder in {{distro}}.",
  "wsl.onboarding.updateClisisCoder": "Update clisisCoder",
  "wsl.onboarding.clisisCoderReadyIn": "clisisCoder is ready in {{distro}}.",
  "wsl.onboarding.clisisCoderReady": "clisisCoder is ready.",
  "wsl.onboarding.installclisisCoderIn": "Install clisisCoder in {{distro}}.",
  "wsl.onboarding.installClisisCoder": "Install clisisCoder",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen ClisisCoder.",
  ...
  "toast.update.description": "A new version of clisisCoder ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the clisisCoder team",
  ...
  "error.chain.checkConfig": "Check your config (clisiscoder.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, clisisCoder does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "clisisCoder includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the clisisCoder server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for clisisCoder",
  ...
  "settings.general.row.appearance.description": "Customise how clisisCoder looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether clisisCoder follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how clisisCoder is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when clisisCoder launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of ClisisCoder.",
