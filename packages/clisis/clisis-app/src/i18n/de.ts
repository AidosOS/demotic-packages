...
export const dict = {
  ...
  "dialog.provider.clisis-coder.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.clisis-coder.tagline": "ZuverlÃ¤ssige, optimierte Modelle",
  "dialog.provider.clisisCoderGo.tagline": "KostengÃ¼nstiges Abo fÃ¼r alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von clisisCoder",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-SchlÃ¼ssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in clisisCoder zu nutzen.",
  ...
  "provider.connect.clisisCoderZen.line1":
    "clisisCoder Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlÃ¤ssiger, optimierter Modelle fÃ¼r Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in clisisCoder zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in clisisCoder zu nutzen.",
  ...
  "dialog.plugins.empty": "In clisiscoder.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den ClisisCoder-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von clisisCoder ({{version}}) ist zur Installation verfÃ¼gbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem ClisisCoder-Team",
  ...
  "error.chain.checkConfig": "ÃœberprÃ¼fen Sie Ihre Konfiguration (clisiscoder.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: clisisCoder unterstÃ¼tzt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "clisisCoder enthÃ¤lt kostenlose Modelle, damit Sie sofort loslegen kÃ¶nnen.",
  ...
  "settings.desktop.wsl.description": "ClisisCoder-Server innerhalb von WSL unter Windows ausfÃ¼hren.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache fÃ¼r clisisCoder Ã¤ndern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie clisisCoder auf Ihrem GerÃ¤t aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "WÃ¤hlen Sie, ob clisisCoder dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von clisisCoder anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von clisisCoder automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von ClisisCoder.",
