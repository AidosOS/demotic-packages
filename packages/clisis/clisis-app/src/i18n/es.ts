export const dict = {
  ...
  "dialog.provider.clisis-coder.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y mÃ¡s",
  "dialog.provider.clisis-coder.tagline": "Modelos optimizados y fiables",
  "dialog.provider.clisisCoderGo.tagline": "SuscripciÃ³n econÃ³mica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por clisisCoder",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en ClisisCoder.",
  ...
  "provider.connect.clisisCoderZen.line1":
    "clisisCoder Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programaciÃ³n.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu cÃ³digo de autorizaciÃ³n para conectar tu cuenta y usar modelos de {{provider}} en ClisisCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el cÃ³digo a continuaciÃ³n para conectar tu cuenta y usar modelos de {{provider}} en ClisisCoder.",
  ...
  "dialog.plugins.empty": "Plugins configurados en clisiscoder.json",
  ...
  "dialog.server.description": "Cambiar a quÃ© servidor de clisisCoder se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versiÃ³n de clisisCoder ({{version}}) estÃ¡ disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de clisisCoder",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuraciÃ³n (clisiscoder.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" fallÃ³. Nota, clisisCoder no soporta autenticaciÃ³n MCP todavÃ­a.',
  ...
  "sidebar.gettingStarted.line1": "clisisCoder incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor clisisCoder dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualizaciÃ³n para clisisCoder",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cÃ³mo se ve clisisCoder en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si clisisCoder sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de ClisisCoder.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automÃ¡ticamente cuando se inicia clisisCoder",
  ...
  "settings.updates.toast.latest.description": "EstÃ¡s usando la Ãºltima versiÃ³n de ClisisCoder.",
