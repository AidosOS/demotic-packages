...
const directory = "C:/clisisCoder/ContextResizeRegression"
...
const model = { providerID: "clisisCoder", modelID: "claude-opus-4-6", variant: "max" }
...
async function mockServer(page: Page) {
  await mockclisisCoderServer(page, {
    directory,
    project: project(),
    provider: provider(),
    sessions: [session()],
...
function provider() {
  return {
    ...
    connected: ["clisisCoder"],
    default: { providerID: "clisisCoder", modelID: "claude-opus-4-6" },
  }
}
