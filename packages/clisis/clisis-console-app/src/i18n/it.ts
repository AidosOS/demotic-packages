...
export const dict = {
  ...
  "notFound.title": "Non trovato | clisisCoder",
  "notFound.heading": "404 - Pagina non trovata",
  "notFound.home": "Home",
  "notFound.docs": "Documentazione",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo chiaro di clisisCoder",
  "notFound.logoDarkAlt": "logo scuro di clisisCoder",
  ...
  "app.meta.description": "clisisCoder - L'agente di programmazione open source.",

  "home.title": "clisisCoder | L'agente di coding IA open source",

  "temp.title": "clisisCoder | Agente di coding IA costruito per il terminale",
  ...
  "temp.feature.zen.afterLink": "fornita da clisisCoder",
  "temp.feature.models.beforeLink": "Supporta 75+ provider LLM tramite",
  "temp.feature.models.afterLink": ", inclusi modelli locali",
  "temp.screenshot.caption": "clisisCoder TUI con il tema tokyonight",
  "temp.screenshot.alt": "clisisCoder TUI con tema tokyonight",
  "temp.logoLightAlt": "logo chiaro di clisisCoder",
  "temp.logoDarkAlt": "logo scuro di clisisCoder",
  ...
  "home.what.title": "Che cos'Ã¨ clisisCoder?",
  "home.what.body": "clisisCoder Ã¨ un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, clisisCoder Ã¨ usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "clisisCoder non archivia il tuo codice nÃ© i dati di contesto, cosÃ¬ puÃ² operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di piÃ¹ su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'Ã¨ clisisCoder?",
  "home.faq.a1":
    "clisisCoder Ã¨ un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. Ãˆ disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso clisisCoder?",
  "home.faq.a2.before": "Il modo piÃ¹ semplice per iniziare Ã¨ leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare clisisCoder?",
  "home.faq.a3.p1":
    "Non necessariamente: clisisCoder include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, clisisCoder funziona anche con i provider piÃ¹ diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con clisisCoder?",
  "home.faq.a4.p1":
    "SÃ¬, clisisCoder supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare clisisCoder solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non piÃ¹! clisisCoder ora Ã¨ disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa clisisCoder?",
  "home.faq.a6":
    "clisisCoder Ã¨ gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "clisisCoder Ã¨ open source?",
  "home.faq.a8.p1": "SÃ¬, clisisCoder Ã¨ completamente open source. Il codice sorgente Ã¨ pubblico su",
  ...
  "home.zenCta.body":
    "Zen ti dÃ  accesso a una selezione di modelli di IA che clisisCoder ha testato e benchmarkato specificamente per agenti di coding. Niente piÃ¹ preoccupazioni per prestazioni e qualitÃ  incoerenti tra provider: usa modelli validati che funzionano.",
  "home.zenCta.link": "Scopri Zen",

  "zen.title": "clisisCoder Zen | Una selezione curata di modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.body":
    "Zen ti dÃ  accesso a una selezione di modelli di IA che clisisCoder ha testato e benchmarkato specificamente per agenti di coding. Niente piÃ¹ preoccupazioni per prestazioni e qualitÃ  incoerenti tra provider: usa modelli validati che funzionano.",

  "zen.faq.q1": "Cos'Ã¨ clisisCoder Zen?",
  "zen.faq.a1":
    "Zen Ã¨ un set curato di modelli di IA testati e benchmarkati per agenti di coding, creato dal team dietro ClisisCoder.",
  ...
  "zen.faq.a3":
    "Zen non Ã¨ a scopo di lucro. Zen ribalta i costi dei provider di modelli direttamente su di te. PiÃ¹ Zen viene usato, piÃ¹ clisisCoder puÃ² negoziare tariffe migliori e passarle a te.",
  ...
  "zen.faq.a4.p3":
    "Per coprire i costi, clisisCoder aggiunge solo una piccola commissione di elaborazione del pagamento di $1.23 per ogni ricarica di saldo da $20.",
  ...
  "zen.faq.a8":
    "Anche se Zen funziona alla grande con clisisCoder, puoi usare Zen con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",
  ...
  "zen.problem.subtitle": "Stiamo risolvendo questo problema per tutti, non solo per gli utenti ClisisCoder.",
  ...
  "zen.how.body": "Anche se ti consigliamo di utilizzare Zen con clisisCoder, puoi utilizzare Zen con qualsiasi agente.",
  ...
  "go.title": "clisisCoder Go | Modelli di coding a basso costo per tutti",
  "go.meta.description":
  ...
  "go.problem.body":
    "Ci concentriamo nel portare l'esperienza clisisCoder a quante piÃ¹ persone possibile. clisisCoder Go Ã¨ un abbonamento a basso costo: $5 il primo mese, poi $10/mese. Offre limiti generosi e accesso affidabile ai modelli open source piÃ¹ capaci.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go inizia a $5 per il primo mese, poi $10/mese. Puoi usarlo con clisisCoder o qualsiasi agente.",
  ...
  "go.faq.q1": "Che cos'Ã¨ clisisCoder Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "La promozione gratuita di {{model}} Ã¨ terminata. Puoi continuare a usare il modello abbonandoti a clisisCoder Go - {{link}}",

  "black.meta.title": "clisisCoder Black | Accedi ai migliori modelli di coding al mondo",
  "black.meta.description":
    "Ottieni l'accesso a Claude, GPT, Gemini e altri con i piani di abbonamento clisisCoder Black.",
  "black.hero.title": "Accedi ai migliori modelli di coding al mondo",
  "black.hero.subtitle": "Inclusi Claude, GPT, Gemini e altri",
  "black.title": "clisisCoder Black | Prezzi",
  ...
  "black.workspace.title": "clisisCoder Black | Seleziona Workspace",
  "black.workspace.selectPlan": "Seleziona un workspace per questo piano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Abbonati a clisisCoder Black",
  ...
  "black.subscribe.success.title": "Sei nella lista d'attesa di clisisCoder Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con clisisCoder quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona clisisCoder",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia clisisCoder ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi ClisisCoder.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API clisisCoder Gateway",
  ...
  "workspace.black.subscription.message": "Sei abbonato a clisisCoder Black per ${{plan}} al mese.",
  ...
  "workspace.black.waitlist.joined": "Sei nella waitlist per il piano clisisCoder Black da ${{plan}} al mese.",
  "workspace.black.waitlist.ready": "Siamo pronti per iscriverti al piano clisisCoder Black da ${{plan}} al mese.",
  ...
  "workspace.lite.subscription.message": "Sei abbonato a clisisCoder Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Seleziona "clisisCoder Go" come provider nella tua configurazione clisisCoder per utilizzare i modelli Go.',
  "workspace.lite.black.message":
    "Attualmente sei abbonato a clisisCoder Black o sei in lista d'attesa. Annulla l'iscrizione prima se desideri passare a Go.",
  "workspace.lite.other.message":
    "Un altro membro in questo workspace Ã¨ giÃ  abbonato a clisisCoder Go. Solo un membro per workspace puÃ² abbonarsi.",
  "workspace.lite.promo.description":
    "clisisCoder Go parte da {{price}}, poi $10/mese, e offre un accesso affidabile a popolari modelli di coding aperti con generosi limiti di utilizzo.",
  ...
  "download.meta.description": "Scarica clisisCoder per macOS, Windows e Linux",
  "download.hero.title": "Scarica clisisCoder",
  ...
  "download.faq.a3.beforeLocal":
    "Non necessariamente, ma probabilmente. Avrai bisogno di un abbonamento IA se vuoi collegare clisisCoder a un provider a pagamento, sebbene tu possa lavorare con",
  ...
  "download.faq.a3.afterZen": ", clisisCoder funziona con tutti i provider popolari come OpenAI, Anthropic, xAI ecc.",

  "download.faq.a5.p1": "clisisCoder Ã¨ gratuito al 100%.",
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi proverranno dal tuo abbonamento a un provider di modelli. Mentre clisisCoder funziona con qualsiasi provider di modelli, raccomandiamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in ClisisCoder.",
  "download.faq.a6.p2.beforeShare": "Scopri di piÃ¹ sulle",
  "download.faq.a6.shareLink": "pagine condivise",

  "enterprise.title": "clisisCoder | Soluzioni Enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta clisisCoder per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice Ã¨ tuo",
  "enterprise.hero.body1":
    "clisisCoder opera in modo sicuro all'interno della tua organizzazione senza dati o contesto archiviati e senza restrizioni di licenza o rivendicazioni di proprietÃ . Inizia una prova con il tuo team, poi distribuisci attraverso la tua organizzazione integrandolo con il tuo SSO e gateway IA interno.",
  ...
  "enterprise.faq.q1": "Cos'Ã¨ clisisCoder Enterprise?",
  "enterprise.faq.a1":
    "clisisCoder Enterprise Ã¨ per le organizzazioni che vogliono garantire che il loro codice e dati non lascino mai la loro infrastruttura. PuÃ² farlo usando una configurazione centralizzata che si integra con il tuo SSO e gateway IA interno.",
  "enterprise.faq.q2": "Come inizio con clisisCoder Enterprise?",
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. clisisCoder per impostazione predefinita non archivia il tuo codice o dati di contesto, rendendo facile iniziare. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.q4": "I miei dati sono sicuri con clisisCoder Enterprise?",
  "enterprise.faq.a4":
    "SÃ¬. clisisCoder non archivia il tuo codice o dati di contesto. Tutto il trattamento avviene localmente o attraverso chiamate API dirette al tuo provider IA. Con configurazione centrale e integrazione SSO, i tuoi dati rimangono sicuri all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "clisisCoder | Brand",
  "brand.meta.description": "Linee guida del brand clisisCoder",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand ClisisCoder.",
  "brand.downloadAll": "Scarica tutti gli asset",

  "changelog.title": "clisisCoder | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog clisisCoder",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti a clisisCoder",
