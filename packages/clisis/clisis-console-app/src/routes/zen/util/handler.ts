...
import { centsToMicroCents } from "@demotic/clisis-console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@demotic/clisis-console-core/util/date.js"
import { Identifier } from "@demotic/clisis-console-core/identifier.js"
import { Billing } from "@demotic/clisis-console-core/billing.js"
import { Actor } from "@demotic/clisis-console-core/actor.js"
import { WorkspaceTable } from "@demotic/clisis-console-core/schema/workspace.sql.js"
import { ZenData } from "@demotic/clisis-console-core/model.js"
import { Subscription } from "@demotic/clisis-console-core/subscription.js"
import { BlackData } from "@demotic/clisis-console-core/black.js"
import { UserTable } from "@demotic/clisis-console-core/schema/user.sql.js"
import { ModelTable } from "@demotic/clisis-console-core/schema/model.sql.js"
import { ProviderTable } from "@demotic/clisis-console-core/schema/provider.sql.js"
...
import { LiteData } from "@demotic/clisis-console-core/lite.js"
import { Resource } from "@demotic/clisis-console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-clisis-coder-session") ?? ""
    const requestId = input.request.headers.get("x-clisis-coder-request") ?? ""
    const ocClient = input.request.headers.get("x-clisis-coder-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-clisis-coder-request")
          headers.delete("x-clisis-coder-session")
          headers.delete("x-clisis-coder-project")
          headers.delete("x-clisis-coder-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://clisiscoder.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://clisiscoder.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://clisiscoder.ai/workspace/${authInfo.workspaceID}/members`
