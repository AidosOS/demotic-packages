...
import compareVideo from "../../asset/lander/ClisisCoder-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/ClisisCoder-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="clisisCoder:auth" content={loggedin() ? "true" : "false"} />
