...
import { Database, eq, and, isNull } from "@demotic/clisis-console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@demotic/clisis-console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#ClisisCoder-go")} target="_blank" rel="noopener noreferrer">
