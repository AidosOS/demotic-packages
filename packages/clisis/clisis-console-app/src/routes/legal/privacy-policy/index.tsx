...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>clisisCoder | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="clisisCoder privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At clisisCoder, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of clisisCoder is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://clisiscoder.ai/legal/terms-of-service</a>,
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the clisisCoder website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about ClisisCoder.
                </li>
              ...
              <p>
                ...
                you, clisisCoder or another party; enforcing any agreements with you; responding to claims that any posting
