...
import desktopAppIcon from "../../asset/lander/ClisisCoder-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://clisiscoder.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>ClisisCoder.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g clisis-coder")}>
                <code>
                  npm i -g <strong>clisis-coder</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g clisis-coder")}>
                <code>
                  bun add -g <strong>clisis-coder</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install AidosOS/tap/clisis-coder")}>
                <code>
                  brew install <strong>AidosOS/tap/clisis-coder</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S clisisCoder")}>
                <code>
                  paru -S <strong>clisisCoder</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask clisis-coder-desktop")}>
                <code>
                  brew install --cask <strong>clisis-coder-desktop</strong>
                </code>
                <CopyStatus />
              </button>
