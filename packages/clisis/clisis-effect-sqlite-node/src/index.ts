...
export const TypeId: TypeId = "~@demotic/clisis-effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@demotic/clisis-effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@demotic/clisis-effect-sqlite-node/NodeSqliteClient")
