...
class Database extends Context.Service<Database, DatabaseShape>()("@demotic/clisis-example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@demotic/clisis-example/UserStore") {
