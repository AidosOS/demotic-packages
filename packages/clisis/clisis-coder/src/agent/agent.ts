...
import { type DeepMutable } from "@demotic/clisis-core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".clisis-coder", "plans", "*.md")]: "allow",
