...
// Schemas â€” these are pure data; nothing checks class identity (see PR
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-Question") {}
