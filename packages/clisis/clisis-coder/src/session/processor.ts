...
import { toolFileSourceFromUri, Usage, type LLMEvent } from "@demotic/clisis-llm"
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-SessionProcessor") {}
