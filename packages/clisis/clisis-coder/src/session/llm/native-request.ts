import type { JsonSchema, LLMRequest, ProviderMetadata } from "@demotic/clisis-llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@demotic/clisis-llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @demotic/clisis-llm request objects from clisisCoder's session/AI SDK-shaped data.
  return LLM.request({
