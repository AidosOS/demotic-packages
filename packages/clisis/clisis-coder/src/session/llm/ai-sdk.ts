import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@demotic/clisis-llm"
...
// Move this extraction into @demotic/clisis-llm when Copilot is handled by the native runtime.
