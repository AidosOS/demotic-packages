...
import { buildPrompt } from "@demotic/clisis-core/session/compaction"
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-SessionCompaction") {}
