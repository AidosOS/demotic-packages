...
import { Slug } from "@demotic/clisis-core/util/slug"
...
import type { ProviderMetadata, Usage } from "@demotic/clisis-llm"
...
import { PartTable, SessionTable } from "@demotic/clisis-core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@demotic/clisis-core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".clisis-coder", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-Session") {}
