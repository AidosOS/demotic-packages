...
import type { LLMEvent } from "@demotic/clisis-llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@demotic/clisis-llm/route"
import type { LLMClientService } from "@demotic/clisis-llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via clisisCoder's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @demotic/clisis-llm. It
