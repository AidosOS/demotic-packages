...
export type AssistantTokenCost = Pick<clisisCoderAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<clisisCoderAssistantMessage, "role"> &
  Partial<Pick<clisisCoderAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@demotic/clisis-ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@demotic/clisis-ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-ACPUsage") {}
