...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@demotic/clisis-ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-ACPDirectory") {}
