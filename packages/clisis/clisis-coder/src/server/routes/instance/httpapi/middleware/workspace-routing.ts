...
>()("@demotic/clisis-ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@demotic/clisis-ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.CLISIS_CODER_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.CLISIS_CODER_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-clisis-coder-directory"] || process.cwd()
}
