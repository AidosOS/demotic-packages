...
export const RootHttpApi = HttpApi.make("ClisisCoder-root")
...
export const InstanceHttpApi = HttpApi.make("ClisisCoder-instance")
...
export const clisisCoderHttpApi = HttpApi.make("clisisCoder")
