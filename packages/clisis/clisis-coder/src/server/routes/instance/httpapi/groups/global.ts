...
import "@demotic/clisis-core/account"
import "@/server/event"
    ...
    .add(
      HttpApiEndpoint.get("health", GlobalPaths.health, {
        ...
        OpenApi.annotations({
          ...
          summary: "Get health",
          description: "Get health information about the clisisCoder server.",
        }),
      ),
      HttpApiEndpoint.get("event", GlobalPaths.event, {
        ...
        OpenApi.annotations({
          ...
          description: "Subscribe to global events from the clisisCoder system using server-sent events.",
        }),
      ),
      HttpApiEndpoint.get("configGet", GlobalPaths.config, {
        ...
        OpenApi.annotations({
          ...
          description: "Retrieve the current global clisisCoder configuration settings and preferences.",
        }),
      ),
      HttpApiEndpoint.patch("configUpdate", GlobalPaths.config, {
        ...
        OpenApi.annotations({
          ...
          description: "Update global clisisCoder configuration settings and preferences.",
        }),
      ),
      HttpApiEndpoint.post("dispose", GlobalPaths.dispose, {
        ...
        OpenApi.annotations({
          ...
          description: "Clean up and dispose all clisisCoder instances, releasing all resources.",
        }),
      ),
      HttpApiEndpoint.post("upgrade", GlobalPaths.upgrade, {
        ...
        OpenApi.annotations({
          ...
          summary: "Upgrade clisisCoder",
          description: "Upgrade clisisCoder to the specified version or latest if not specified.",
        }),
      ),
    )
