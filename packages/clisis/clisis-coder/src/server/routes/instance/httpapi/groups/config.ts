      ...
      .add(
        HttpApiEndpoint.get("get", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the current clisisCoder configuration settings and preferences.",
          }),
        ),
        HttpApiEndpoint.patch("update", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Update clisisCoder configuration settings and preferences.",
          }),
        ),
