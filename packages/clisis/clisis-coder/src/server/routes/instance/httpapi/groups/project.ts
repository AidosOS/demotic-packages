      ...
      .add(
        HttpApiEndpoint.get("list", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of projects that have been opened with ClisisCoder.",
          }),
        ),
        HttpApiEndpoint.get("current", `${root}/current`, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the currently active project that clisisCoder is working with.",
          }),
        ),
