...
import { AccountStateTable, AccountTable } from "@demotic/clisis-core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-AccountRepo") {}
