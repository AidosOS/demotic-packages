...
import { which } from "@demotic/clisis-core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@demotic/clisis-core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.CLISIS_CODER_FAKE_VCS)
