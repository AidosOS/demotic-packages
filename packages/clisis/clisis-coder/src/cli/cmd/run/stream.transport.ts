...
import type { Event, GlobalEvent, clisisCoderClient } from "@demotic/clisis-sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@demotic/clisis-RunStreamTransport") {}
