...
//
// The saved variant persists across sessions in ~/.local/state/clisisCoder/model.json
...
class Service extends Context.Service<Service, VariantService>()("@demotic/clisis-RunVariant") {}
...
export function formatModelLabel(
  ...
  const label = variant ? ` Â· ${variant}` : ""
  return `${names.model} Â· ${names.provider}${label}`
}
