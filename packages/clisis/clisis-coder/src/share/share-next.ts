import type * as SDK from "@demotic/clisis-sdk/v2"
...
import { SessionShareTable } from "@demotic/clisis-core/share/sql"
...
const disabled = process.env["CLISIS_CODER_DISABLE_SHARE"] === "true" || process.env["CLISIS_CODER_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-ShareNext") {}
