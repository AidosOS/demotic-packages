...
import { EventSequenceTable, EventTable } from "@demotic/clisis-core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CLISIS_CODER_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CLISIS_CODER_WORKSPACE_ID: config.id,
        CLISIS_CODER_EXPERIMENTAL_WORKSPACES: "true",
