...
<html>
  <head>
    <title>clisisCoder - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>clisisCoder - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "clisisCoder"
      output.headers["User-Agent"] = `clisisCoder/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
