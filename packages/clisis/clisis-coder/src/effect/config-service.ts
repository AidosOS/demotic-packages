 ...
 *   "@demotic/clisis-ServerAuthConfig",
 *   {
 *     password: Config.string("CLISIS_CODER_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CLISIS_CODER_SERVER_USERNAME").pipe(Config.withDefault("clisisCoder")),
 *   },
 * ) {}
 *
