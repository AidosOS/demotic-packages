...
export class Service extends Context.Service<Service, Interface>()("@demotic/clisis-Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __CLISIS_CODER_PHOTON_WASM_PATH?: string }).__CLISIS_CODER_PHOTON_WASM_PATH =
