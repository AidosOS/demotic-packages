...
```text
Configuration is invalid at /path/to/clisiscoder.json
â†³ Expected object, got "not-object" provider.bad.options
...
to avoid: a user-authored invalid `clisiscoder.json` crossed the HttpApi boundary
