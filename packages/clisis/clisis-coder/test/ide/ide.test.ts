...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CLISIS_CODER_CALLER", () => {
    process.env["CLISIS_CODER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CLISIS_CODER_CALLER", () => {
    process.env["CLISIS_CODER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CLISIS_CODER_CALLER", () => {
    process.env["CLISIS_CODER_CALLER"] = "unknown"
