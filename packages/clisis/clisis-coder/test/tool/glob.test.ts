  ...
  references.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "ClisisCoder-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "ClisisCoder-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "ClisisCoder-glob-reference/repo",
        },
      },
    },
  )
