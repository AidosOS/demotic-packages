  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const headers = { "x-clisis-coder-directory": tmp.directory, "content-type": "application/json" }
        ...
        const response = yield* Effect.promise(() =>
          HttpApiApp.webHandler().handler(
            new Request(`http://localhost${SyncPaths.history}`, {
              method: "POST",
              headers: { "x-clisis-coder-directory": tmp.directory, "content-type": "application/json" },
