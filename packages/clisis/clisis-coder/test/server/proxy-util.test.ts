...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips ClisisCoder-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-clisis-coder-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-clisis-coder-directory")).toBeNull()
      expect(result.get("x-clisis-coder-workspace")).toBeNull()
