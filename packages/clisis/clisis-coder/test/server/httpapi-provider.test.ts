...
function writeProviderAuthPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* Effect.promise(() => markPluginDependenciesReady(path.join(dir, ".clisis-coder")))

    yield* fs.writeWithDirs(
      path.join(dir, ".clisis-coder", "plugin", "provider-oauth-parity.ts"),
      [
        "export default {",
...
function writeProviderAuthValidationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".clisis-coder", "plugin", "provider-oauth-validation.ts"),
      [
        "export default {",
...
function writeFunctionOptionsPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".clisis-coder", "plugin", "provider-function-options.ts"),
      [
        "export default {",
...
function writeProviderModelsMutationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".clisis-coder", "plugin", "provider-models-mutation.ts"),
      [
        "export default {",
...
describe("provider HttpApi", () => {
  it.instance.skip(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* request("/api/provider/missing", {
        headers: { "x-clisis-coder-directory": directory },
      })
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      const directory = (yield* TestInstance).directory
      const headers = { "x-clisis-coder-directory": directory, "content-type": "application/json" }
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* requestAuthorize({
        ...
        method: 0,
        inputs: { token: "nope" },
        headers: { "x-clisis-coder-directory": directory, "content-type": "application/json" },
      })
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const headers = { "x-clisis-coder-directory": directory }
