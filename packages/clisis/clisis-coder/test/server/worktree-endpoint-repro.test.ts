...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      CLISIS_CODER_EXPERIMENTAL_WORKSPACES: Flag.CLISIS_CODER_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.CLISIS_CODER_EXPERIMENTAL_WORKSPACES = original.CLISIS_CODER_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
