...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/ClisisCoder.git")).toEqual({ owner: "sst", repo: "clisisCoder" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/clisisCoder")).toEqual({ owner: "sst", repo: "clisisCoder" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/ClisisCoder.git")).toEqual({ owner: "sst", repo: "clisisCoder" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/clisisCoder")).toEqual({ owner: "sst", repo: "clisisCoder" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/ClisisCoder.git")).toEqual({ owner: "sst", repo: "clisisCoder" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/clisisCoder")).toEqual({ owner: "sst", repo: "clisisCoder" })
})
