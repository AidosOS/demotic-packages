...
const withHome = <A, E, R>(home: string, self: Effect.Effect<A, E, R>) =>
  Effect.acquireUseRelease(
    Effect.sync(() => {
      const prev = process.env.CLISIS_CODER_TEST_HOME
      process.env.CLISIS_CODER_TEST_HOME = home
      return prev
    }),
    () => self,
    (prev) =>
      Effect.sync(() => {
        process.env.CLISIS_CODER_TEST_HOME = prev
      }),
  )

describe("skill", () => {
  it.live("discovers skills from .clisis-coder/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".clisis-coder", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".clisis-coder", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".clisis-coder", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .clisis-coder/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".clisis-coder", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".clisis-coder", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".clisis-coder", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".clisis-coder", "skill", "manual-skill", "SKILL.md"),
              `---
name: manual-skill
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".clisis-coder", "skill", "ClisisCoder-skill", "SKILL.md"),
                `---
name: ClisisCoder-skill
description: A skill in the .clisis-coder/skill directory.
---
...
`,
          ...
          const skill = yield* Skill.Service
          const list = (yield* skill.all()).filter((s) => s.location !== "<built-in>")
          expect(list.map((s) => s.name)).toEqual(["ClisisCoder-skill"])
        }),
      { git: true },
    ),
  )
...
`,
              ...
              Bun.write(
                path.join(dir, ".clisis-coder", "skill", "agent-skill", "SKILL.md"),
                `---
name: ClisisCoder-skill
description: A skill in the .clisis-coder/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".clisis-coder", "skills", "agent-skill", "SKILL.md"),
                `---
name: ClisisCoder-skill
description: A skill in the .clisis-coder/skills directory.
---
