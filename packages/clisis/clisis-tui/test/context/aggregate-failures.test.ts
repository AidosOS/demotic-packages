...
import { aggregateFailures } from "@demotic/clisis-tui/context/aggregate-failures"
...
describe("aggregateFailures", () => {
  ...
  test("formats structured config errors hidden inside SDK error causes", () => {
    ...
    expect(err!.message).toContain("config.get: Configuration is invalid at /tmp/clisiscoder.json")
