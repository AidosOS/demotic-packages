...
import defaultSoundPath from "@demotic/clisis-ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@demotic/clisis-ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@demotic/clisis-ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@demotic/clisis-ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@demotic/clisis-ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@demotic/clisis-ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "clisisCoder"
const DEFAULT_PACK_ID = "clisis-coder.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "clisisCoder Default",
  builtin: true,
  sounds: {
