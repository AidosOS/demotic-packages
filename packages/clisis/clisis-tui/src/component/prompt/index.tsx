...
import type { AssistantMessage, FilePart, UserMessage } from "@demotic/clisis-sdk/v2"
...
import { CLISIS_CODER_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useclisisCoderKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.CLISIS_CODER_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
