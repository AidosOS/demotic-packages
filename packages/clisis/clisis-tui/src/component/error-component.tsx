...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  const issueURL = new URL("https://github.com/AidosOS/demotic-clisis-coder/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("ClisisCoder-version", InstallationVersion)
