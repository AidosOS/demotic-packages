...
import { FileComponentProvider } from "@demotic/clisis-ui/context/file"
import { WorkerPoolProvider } from "@demotic/clisis-ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@demotic/clisis-ui/logo"
import { IconButton } from "@demotic/clisis-ui/icon-button"
import { ProviderIcon } from "@demotic/clisis-ui/provider-icon"
import { iife } from "@demotic/clisis-core/util/iife"
import { Binary } from "@demotic/clisis-core/util/binary"
import { NamedError } from "@demotic/clisis-core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@demotic/clisis-ui/tabs"
import { MessageNav } from "@demotic/clisis-ui/message-nav"
import { FileSSR } from "@demotic/clisis-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@demotic/clisis-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/ClisisCoder-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | clisisCoder</Title>
              </Show>
              <Meta name="description" content="clisisCoder - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              ...
                              <IconButton
                                as={"a"}
                                href="https://clisiscoder.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
