...
declare const CLISIS_CODER_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof CLISIS_CODER_CLI_NAME === "string" ? CLISIS_CODER_CLI_NAME : "clisisCoder", {
  description: "clisisCoder 2.0 preview command line interface",
  commands: [
    Spec.make("debug", {
