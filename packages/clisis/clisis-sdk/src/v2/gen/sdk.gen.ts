...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new clisisCoderClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the clisisCoder system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the clisisCoder system.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local clisisCoder state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global clisisCoder configuration settings and preferences.
   */
   ...
   *
   * Update global clisisCoder configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the clisisCoder server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the clisisCoder system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all clisisCoder instances, releasing all resources.
   */
   ...
   * Upgrade clisisCoder
   *
   * Upgrade clisisCoder to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current clisisCoder configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update clisisCoder configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current clisisCoder instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the clisisCoder system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with ClisisCoder.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that clisisCoder is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by ClisisCoder.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all clisisCoder sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new clisisCoder session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific clisisCoder session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class clisisCoderClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<clisisCoderClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    clisisCoderClient.__registry.set(this, args?.key)
  }
