import clisisCoderWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  href: "https://github.com/AidosOS/demotic-clisis-coder",
  apiHref: "https://api.github.com/repos/AidosOS/demotic-clisis-coder",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star clisisCoder on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "clisisCoder:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://clisiscoder.ai/">
            <strong>Try clisisCoder</strong>
          </a>
          <button
...
function clisisCoderMark() {
  return (
    <svg data-slot="clisis-coder-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://clisiscoder.ai/legal/terms-of-service", label: "Terms of service" },
    { href: "https://clisiscoder.ai/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@ClisisCoder.ai", label: "Contact us" },
    { href: "https://clisiscoder.ai/discord", label: "Community" },
    { href: "https://x.com/clisisCoder", label: "X" },
    githubLink,
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://ClisisCoder.ai" aria-label="clisisCoder home">
          <clisisCoderMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={clisisCoderWordmarkDark} alt="clisisCoder" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">clisisCoder Newsletter</h2>
            <p>
