...
const statsHomeTitle = "clisisCoder Stats"
const statsHomeDescription = "clisisCoder usage, market share, token cost, and session cost stats."
const statsHomeFallbackUrl = "https://clisiscoder.ai/stats/"
const statsUnfurlPath = "banner.png"
const statsUnfurlAlt = "clisisCoder Stats wordmark on a dark patterned background"
const usageColors = [
  "#ed6aff",
  "#a684ff",
  "#7c86ff",
  ...
  return (
    <section id="top-models" data-section="top-models">
      <h2 data-slot="top-models-title">
        <strong>Top models.</strong> <span>Usage of models across clisisCoder Go.</span>
      </h2>
      <Show
