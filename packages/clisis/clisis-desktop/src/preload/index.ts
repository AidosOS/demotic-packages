...
const api: ElectronAPI = {
  ...
  wslServers: {
    ...
    probeClisisCoder: (name) => ipcRenderer.invoke("wsl-servers-probe-clisisCoder", name),
    installClisisCoder: (name) => ipcRenderer.invoke("wsl-servers-install-clisisCoder", name),
