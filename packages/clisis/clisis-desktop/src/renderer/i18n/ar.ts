export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من clisisCoder",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من clisisCoder، هل ترغب في تثبيته وإعادة تشغيله؟",
