export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do clisisCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do clisisCoder foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada em {{path}}\n\nReinicie seu terminal para usar o comando 'clisisCoder'.",
