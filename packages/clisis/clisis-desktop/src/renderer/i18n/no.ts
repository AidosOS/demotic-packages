export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av clisisCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av clisisCoder er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'clisisCoder'-kommandoen.",
