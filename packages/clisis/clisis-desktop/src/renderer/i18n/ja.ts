export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの clisisCoder を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "clisisCoder のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'clisisCoder' コマンドを使用してください。",
