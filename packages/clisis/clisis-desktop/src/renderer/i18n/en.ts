export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of clisisCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of clisisCoder has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'clisisCoder' command.",
