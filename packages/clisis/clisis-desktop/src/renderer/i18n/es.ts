export const dict = {
  ...
  "desktop.updater.none.message": "Ya estÃ¡s usando la versiÃ³n mÃ¡s reciente de clisisCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versiÃ³n {{version}} de ClisisCoder. Â¿Quieres instalarla y reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada en {{path}}\n\nReinicia tu terminal para usar el comando 'clisisCoder'.",
