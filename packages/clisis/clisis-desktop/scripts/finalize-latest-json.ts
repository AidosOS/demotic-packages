...
const releaseId = process.env.CLISIS_CODER_RELEASE
if (!releaseId) throw new Error("CLISIS_CODER_RELEASE is required")

const version = process.env.CLISIS_CODER_VERSION
if (!version) throw new Error("CLISIS_CODER_VERSION is required")
...
const macxTarGz = "ClisisCoder-desktop-mac-x64.app.tar.gz"
const macaTarGz = "ClisisCoder-desktop-mac-arm64.app.tar.gz"
