...
const VideoReadySvg = () => (
  ...
  >
    <polygon points="23 7 16 12 23 17 23 7" />
    <rect x="1" y="5" width="15" height="14" rx="2" ry="2" />
    <polyline points="7 10 10 13 15 8" stroke="#4262ff" strokeWidth="2.5" />
  </svg>
);
...
function ModelDropdown({ selectedModel, onSelect, onClose }) {
  ...
  const getProviderStyle = (provider) => {
    switch (provider) {
      ...
      case "bytedance":
        return { text: "BD", bg: "bg-[#ffd02f]/10 text-[#ffd02f] border-[#ffd02f]/25" };
      case "midjourney":
      ...
      case "vidu":
        return { text: "VD", bg: "bg-[#4262ff]/10 text-[#4262ff] border-[#4262ff]/25" };
      case "minimax":
  ...
  const getIconColor = (m, isV2V) => {
    ...
    if (m.id.includes("veo")) return "bg-[#ffd02f]/10 text-[#ffd02f] border-[#ffd02f]/10";
            ...
            <div className="flex items-center gap-2.5 flex-wrap">
              ...
              {uploadedEndImageUrl && (
                <div className={PROMPT_MEDIA_PREVIEW_CLASS}>
                  ...
                  <span className="absolute bottom-0.5 left-0.5 px-1 h-3.5 bg-black/60 rounded-md text-[7px] font-black text-[#4262ff] leading-none flex items-center justify-center pointer-events-none">
                    END
                  </span>
                </div>
              )}
                ...
                <>
                  {uploadedImageUrls.map((url, idx) => (
                    <div key={url} className={PROMPT_MEDIA_PREVIEW_CLASS}>
                      ...
                      <span className="absolute bottom-0.5 right-0.5 px-1 h-3.5 bg-black/60 rounded-full text-[8px] font-black text-[#4262ff] leading-none flex items-center justify-center pointer-events-none">
                        {idx + 1}
                      </span>
                    </div>
                  ))}
                          ...
                          <div className="flex flex-col items-center justify-center w-full h-full absolute inset-0 bg-black/80 z-20 backdrop-blur-[2px]">
                            <svg className="w-8 h-8 -rotate-90">
                              ...
                              <circle
                                ...
                                className="text-[#4262ff] transition-all duration-300"
                              />
                            </svg>
                            <span className="absolute text-[9px] font-black text-[#4262ff] leading-none">{imageProgress}%</span>
                          </div>
                        ) : (
                  ...
                  >
                    {endImageUploading ? (
                      <div className="flex flex-col items-center justify-center w-full h-full absolute inset-0 bg-black/80 z-20 backdrop-blur-[2px]">
                        ...
                        <span className="absolute text-[9px] font-black text-[#4262ff] leading-none">{endImageProgress}%</span>
                      </div>
                    ) : (
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-white/40 group-hover:text-[#4262ff] transition-colors">
                        <line x1="12" y1="5" x2="12" y2="19" />
                  ...
                  >
                    {videoUploading ? (
                      <div className="flex flex-col items-center justify-center w-full h-full absolute inset-0 bg-black/80 z-20 backdrop-blur-[2px]">
                        ...
                        <span className="absolute text-[9px] font-black text-[#4262ff] leading-none">{videoProgress}%</span>
                      </div>
                    ) : (
                      <svg
                        width="16"
                        ...
                        stroke="currentColor"
                        strokeWidth="2.5"
                        className="text-white/40 group-hover:text-[#4262ff] transition-colors"
                      >
              ...
              {canUploadImageReference && (
                ...
                >
                  <svg
                    ...
                    stroke="currentColor"
                    strokeWidth="2.5"
                    className="opacity-40 text-white group-hover:text-[#4262ff] transition-colors"
                  >
                    <path d="M12 20h9" />
