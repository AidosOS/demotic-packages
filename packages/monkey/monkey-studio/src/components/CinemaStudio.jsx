  ...
  return (
    <section className="flex w-[170px] shrink-0 snap-center flex-col md:w-[190px]">
      <div className="mb-3 flex items-center justify-between px-1">
        ...
        <span className="h-1.5 w-1.5 rounded-full bg-gradient-to-b from-[#4262ff] to-[#ffd02f] shadow-[0_0_6px_rgba(66,98,255,0.5)]" />
      </div>

      <div className="relative h-[320px] overflow-hidden rounded-2xl border border-white/[0.06] bg-[#030303] shadow-inner">
        <div className="pointer-events-none absolute inset-x-2 top-1/2 z-0 h-[82px] -translate-y-1/2 rounded-xl border border-[#4262ff]/20 bg-gradient-to-r from-[#4262ff]/15 to-[#ffd02f]/10 shadow-[0_0_15px_rgba(66,98,255,0.1)]" />
              ...
              >
                <span
                  className={`flex shrink-0 items-center justify-center font-semibold transition-colors ${
                    imageUrl
                      ? "h-10 w-10"
                      : "text-base text-white/55 group-data-[selected=true]:text-[#4262ff]"
                  }`}
                >
                  {imageUrl ? (
                    <img
    ...
    >
      ...
      >
        <div className="flex items-start justify-between border-b border-white/[0.05] px-5 py-5 md:px-7 md:py-6">
          <div>
            <div className="mb-2 flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#4262ff]">
              <svg
                width="15"
                height="15"
                viewBox="0 0 24 24"
        ...
        {history.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full pt-4 animate-fade-in-up">
            {history.map((entry, idx) => (
              <div
                ...
                className="relative group rounded-lg overflow-hidden border border-white/10 bg-[#0a0a0a] shadow-xl hover:border-[#4262ff]/50 transition-all duration-300 flex flex-col cursor-pointer"
              ...
              >
                ...
                <div className="absolute top-2 right-2 hidden md:flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className={`flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-black/60 font-black backdrop-blur-md transition-all hover:bg-[#4262ff] hover:text-black ${
                      copiedPromptIndex === idx ? "text-[#4262ff]" : "text-white"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-black/60 backdrop-blur-md transition-all hover:bg-[#4262ff] hover:text-black ${
                      copiedImageIndex === idx ? "text-[#4262ff]" : "text-white"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className="p-2 bg-black/60 backdrop-blur-md rounded-full text-white hover:bg-[#4262ff] hover:text-black transition-all border border-white/10"
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                ...
                <div className="p-3 bg-black/80 backdrop-blur-sm border-t border-white/5 flex-1 flex flex-col justify-between gap-2">
                  ...
                  <div className="flex items-center mt-1 flex-wrap gap-1">
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] font-bold text-[#4262ff] px-2 py-0.5 bg-[#4262ff]/10 rounded border border-[#4262ff]/20">
                        Cinema Studio
                      </span>
          ...
          <div className="flex flex-col items-center justify-center h-full text-center px-4 animate-fade-in-up transition-all duration-700 min-h-[50vh]">
            ...
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-4 text-center px-4 flex flex-col items-center">
              ...
              <span className="text-[#4262ff] font-black uppercase text-2xl sm:text-4xl sm:mt-1 tracking-tight">
                CINEMA STUDIO
              </span>
            </h1>
      ...
      >
            ...
            <div className="relative pt-0.5">
              ...
              >
                {isUploadingImage ? (
                  ...
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-white/40 group-hover:text-[#4262ff] transition-colors">
          ...
          <PromptFooter>
            <PromptControls>
              ...
              >
                <div className="w-1.5 h-1.5 bg-[#4262ff] rounded-full shadow-lg shadow-[#4262ff]/20 shrink-0" />
                <span className="max-w-[120px] truncate text-xs font-semibold text-white/70 group-hover:text-[#4262ff] transition-colors">
