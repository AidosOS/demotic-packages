...
function UploadButton({ apiKey, maxImages, onSelect, onClear, initialUrls = [], label = null, persistedHistory = null, onHistoryChange = null }) {
  ...
  const triggerContent = uploading ? (
    <div className="flex flex-col items-center justify-center w-full h-full absolute inset-0 bg-black/80 z-20 backdrop-blur-[2px]">
      ...
      <span className="absolute text-[9px] font-black text-[#4262ff] leading-none">
        {lastUploadProgress}%
      </span>
    </div>
  ) : label === "Swap Face" ? (
                    ...
                    <div
                      className={`w-8 h-8 ${
                        m.family === "kontext"
                          ...
                          : m.family === "effects"
                            ? "bg-[#ffd02f]/10 text-[#ffd02f] border-[#ffd02f]/10"
      ...
      <PromptComposer>
          ...
          <PromptFooter>
            ...
            <PromptControls ref={dropdownRef}>
              ...
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="opacity-40 text-white group-hover:text-[#4262ff] transition-colors">
                  <path d="M12 20h9" />
