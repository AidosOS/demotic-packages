...
function CodeBlock({ children, className = '' }) {
  return (
    <pre
      className={`text-[11.5px] font-mono text-[#4262ff] bg-black/50 border border-white/5 rounded-md px-3 py-2 overflow-x-auto whitespace-pre ${className}`}
    >
      {children}
    </pre>
  );
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 flex flex-col gap-12">
        ...
        <section className="flex flex-col items-center text-center gap-4">
          ...
          <p className="text-white/60 text-base md:text-lg max-w-2xl">
            Use Motion Monkey from your terminal, your IDE, or any MCP-compatible
            assistant. Generate cinematic images, videos, and audio across 400+ models —
        ...
        <p className="text-center text-xs text-white/40 pb-4">
          Open-source · BSL 1.1 licensed · Works with Claude, Cursor, Windsurf, and Gemini CLI
        </p>
      </div>
    </div>
  );
