...
const DEFAULT_ACTION_CLASS =
  "bg-[#4262ff] text-black px-7 py-3 rounded-full font-bold text-sm hover:opacity-95 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 w-full sm:w-auto shadow-lg shadow-[#4262ff]/20 hover:shadow-[#4262ff]/35 border border-[#4262ff]/10 z-10 disabled:opacity-50 disabled:cursor-not-allowed";

const CONTROL_LAYOUT_CLASS =
  "h-[38px] flex items-center gap-2 rounded-md transition-all border group whitespace-nowrap shadow-inner focus:outline-none focus-visible:border-[#4262ff]/45 focus-visible:ring-1 focus-visible:ring-[#4262ff]/30";

const CONTROL_IDLE_CLASS =
  "text-white bg-[#16161a]/60 hover:bg-[#202026]/80 border-white/[0.06]";

const CONTROL_ACTIVE_CLASS =
  "text-[#4262ff] bg-[#4262ff]/10 hover:bg-[#4262ff]/15 border-[#4262ff]/25";

const MEDIA_CONTROL_LAYOUT_CLASS =
  "w-10 h-10 shrink-0 rounded-full border transition-all flex items-center justify-center relative overflow-hidden group focus:outline-none focus-visible:border-[#4262ff]/45 focus-visible:ring-1 focus-visible:ring-[#4262ff]/30";
...
export function promptMediaButtonClassName({
  ...
  return joinClasses(
    ...
    active
      ? "border-[#4262ff]/60 bg-[#4262ff]/5 hover:border-[#4262ff]/70"
      : "border-white/[0.03] bg-white/[0.03] hover:bg-white/[0.06] hover:border-[#4262ff]/40",
    className,
  );
}
...
export const PROMPT_CONTROL_LABEL_CLASS =
  "text-xs font-semibold text-current opacity-70 group-hover:text-[#4262ff] group-hover:opacity-100 transition-all";
  ...
  return (
    <button
      ...
      className={joinClasses(
        ...
        "text-xs font-semibold text-white/70 hover:bg-[#4262ff]/10 hover:text-[#4262ff] focus:outline-none focus-visible:bg-[#4262ff]/10 focus-visible:text-[#4262ff]",
        className,
      )}
    >
  ...
  return (
    <button
      ...
      className={joinClasses(
        ...
        "focus:outline-none focus-visible:ring-1 focus-visible:ring-[#4262ff]/40",
        selected
          ? "bg-[#4262ff] text-black shadow-md shadow-[#4262ff]/20"
