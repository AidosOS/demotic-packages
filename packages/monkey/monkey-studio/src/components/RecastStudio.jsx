        ...
        {["videos", "images", "results"].map((tab) => (
          <button
            ...
            className={`flex-1 text-center py-1 text-xs font-bold capitalize transition-colors ${
              activeTab === tab
                ? "text-[#4262ff] border-b border-[#4262ff]"
            ...
            >
              ...
              <div className="w-10 h-10 rounded-lg overflow-hidden bg-white/5 flex-shrink-0 relative">
                ...
                <button
                  ...
                  className="absolute inset-0 bg-black/60 opacity-0 group-hover/item:opacity-100 flex items-center justify-center transition-opacity text-white hover:text-[#4262ff]"
                >
              ...
              <div className="flex items-center gap-1">
                <button
                  type="button"
                  className="text-xs text-black font-black px-2.5 py-1 bg-[#4262ff] rounded-md hover:bg-[#4262ff]/90 transition-colors"
                >
                  Use
                </button>
                <button
          ...
          <div className="flex items-center gap-2 px-1">
            <div className="flex items-center gap-2">
              ...
              <MediaPickerButton
                accept="video/*"
                label="Video"
                icon={<VideoIcon className="text-white/40 group-hover:text-[#4262ff] transition-colors" />}
              ...
              <MediaPickerButton
                ...
                icon={<ImageIcon className="text-white/40 group-hover:text-[#4262ff] transition-colors" />}
          ...
          <PromptFooter>
            <PromptControls>
              ...
              <div className="relative">
                ...
                >
                  <div className="w-3.5 h-3.5 bg-[#4262ff] rounded-sm flex items-center justify-center">
              ...
              <div className="relative">
                ...
                >
                  <svg
                    ...
                    stroke="currentColor"
                    strokeWidth="2"
                    className="text-white/50 group-hover:text-[#4262ff] transition-colors"
                  >
                    <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" />
                    <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" />
                  </svg>
                  <span className="text-xs font-semibold text-white/70 group-hover:text-[#4262ff] transition-colors">
                    Library
                  </span>
                  <PromptChevronIcon />
                </button>
