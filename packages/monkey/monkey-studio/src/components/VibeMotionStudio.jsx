...
// ── icons ─────────────────────────────────────────────────────────────────────
const CheckSvg = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4262ff" strokeWidth="4">
    ...
    <div className="w-full h-full flex flex-col items-center justify-center bg-app-bg relative overflow-hidden">
          ...
          <div className="w-full pt-6 flex justify-center animate-fade-in-up">
            <div className="flex flex-col items-center gap-4 py-16">
              <div className="relative w-20 h-20">
                ...
                <div className="absolute inset-2 rounded-full border-2 border-[#4262ff]/30 animate-spin" />
            ...
            {history.map((entry, idx) => (
              ...
              >
                ...
                <div className={`absolute top-2 left-2 px-2 py-0.5 rounded-md text-[9px] font-bold uppercase tracking-wider backdrop-blur-sm border ${
                  entry.mode === "edit"
                    ? "bg-[#4262ff]/20 text-[#4262ff] border-[#4262ff]/30"
      ...
      <PromptComposer>
          ...
          <div className="flex items-center justify-between gap-3 px-1">
            ...
            {editMode && (
              <div className="flex items-center gap-2 px-3 py-1 bg-[#4262ff]/5 border border-[#4262ff]/10 rounded-full text-[11px] text-[#4262ff] font-medium tracking-tight min-w-0 max-w-full overflow-hidden">
                ...
                <button
                  ...
                  className="ml-auto text-[#4262ff]/40 hover:text-[#4262ff] transition-colors text-sm leading-none flex-shrink-0"
            ...
            <PromptControls ref={controlsRef}>
              ...
              {editMode && editSources.length > 0 && (
                <div className="relative">
                  ...
                  >
                    <div className="w-4 h-4 bg-[#4262ff]/20 rounded flex items-center justify-center border border-[#4262ff]/30">
                      <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#4262ff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                      </svg>
                    </div>
                    <span className={`${PROMPT_CONTROL_LABEL_CLASS} text-[#4262ff]/70 max-w-[120px] truncate`}>
