...
// Inline SVG Icons
// ---------------------------------------------------------------------------
const ScissorsIcon = ({ className = "text-[#4262ff]" }) => (
                        ...
                        return (
                          <button
                            ...
                            className={`w-full p-4 border rounded-lg text-left transition-all hover:bg-zinc-900/60 flex flex-col gap-2 group/hl ${
                              isActive 
                                ? "border-primary bg-primary/5 shadow-[0_0_12px_rgba(66,98,255,0.03)]" 
              ...
              >
                {videoUploading ? (
                  <div className="flex flex-col items-center justify-center w-full h-full absolute inset-0 bg-black/85 z-20 backdrop-blur-[1px]">
                    ...
                    <span className={`absolute text-[8px] font-black text-[#4262ff] leading-none ${videoProgress >= 100 ? "animate-pulse" : ""}`}>
                      {videoProgress >= 100 ? "..." : `${videoProgress}%`}
                    </span>
                  </div>
                ) : null}

                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-white/40 group-hover:text-[#4262ff] transition-colors">
          ...
          <PromptFooter>
            <PromptControls>
              ...
              <div className={promptControlClassName()}>
                <div className="w-4 h-4 bg-[#4262ff] rounded flex items-center justify-center shadow-lg shadow-[#4262ff]/10">
