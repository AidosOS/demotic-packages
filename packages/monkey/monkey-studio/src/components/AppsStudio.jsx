      ...
      >
        ...
        <div className="p-5 flex flex-col flex-1 space-y-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-lg text-[#4262ff] border border-white/5 group-hover:border-white/10 transition-colors">
              <app.icon />
            </div>
          ...
          <div className="flex items-center gap-2 pt-2">
            {isDummy ? (
              <>
                ...
                <button
                  onClick={() => setSelectedApp(app)}
                  className="flex-1 py-2 bg-[#4262ff]/10 text-[#4262ff] rounded-md text-[11px] font-bold uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-[#4262ff]/20 transition-all border border-[#4262ff]/20 active:scale-95"
                >
    ...
    <div className="h-full w-full flex flex-col items-center bg-[#030303] overflow-y-auto custom-scrollbar relative">
      ...
      <div className="flex flex-col gap-10 items-center w-full max-w-7xl pt-12 pb-24 px-6">
        ...
        <div className="text-center space-y-6 max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#4262ff]/10 border border-[#4262ff]/20 rounded-full">
            <FaDollarSign className="text-[#4262ff] text-xs" />
            <span className="text-[10px] font-black text-[#4262ff] uppercase tracking-widest">Revenue-Ready Templates</span>
          </div>
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div key={step} className="flex items-start gap-4 bg-[#0a0a0a] border border-white/5 rounded-2xl p-6 hover:border-white/10 transition-colors">
              <div className="w-12 h-12 shrink-0 rounded-2xl bg-white/5 flex items-center justify-center text-[#4262ff] border border-white/5">
        ...
        <div className="pt-24 pb-12 flex flex-col items-center gap-4">
          <div className="inline-flex items-center gap-3 px-4 py-2 bg-white/5 rounded-full border border-white/5">
            <span className="block w-1.5 h-1.5 rounded-full bg-[#4262ff] animate-pulse" />
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-6">
          ...
          <div className="relative bg-[#0a0a0a] border border-white/10 w-full max-w-md rounded-2xl p-8 space-y-8 animate-scale-up shadow-2xl">
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="w-20 h-20 rounded-[28px] bg-[#4262ff]/10 border border-[#4262ff]/20 flex items-center justify-center text-4xl text-[#4262ff] mb-2">
                <selectedApp.icon />
              </div>
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full py-4 bg-[#4262ff] text-black rounded-md text-sm font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-[#4262ff]/90 transition-all shadow-lg active:scale-95 disabled:opacity-50"
              >
