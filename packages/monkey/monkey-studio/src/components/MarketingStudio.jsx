...
const CheckSvg = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4262ff" strokeWidth="4">
          ...
          >
            {onPreview && !isVideo && (
              <button
                ...
                className="absolute top-1.5 left-1.5 w-6 h-6 bg-black/60 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 hover:bg-[#4262ff] hover:text-black transition-all border border-white/10 z-20 text-white"
              >
              ...
              <div className="relative flex items-center gap-1.5">
                ...
                {avatarImage && (
                  <button
                    ...
                    className={promptControlClassName({
                      iconOnly: true,
                      className: "text-white/40 hover:text-[#4262ff]",
                    })}
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                      <circle cx="11" cy="11" r="8" />
                ...
                <div key={key} className="relative">
                  <button
                    ...
                    className={promptControlClassName({
                      ...
                      className:
                        dropdown === key
                          ? "text-xs font-semibold text-[#4262ff]"
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-[#0d0d0f] shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-4 pt-10 flex flex-col items-center justify-end gap-3">
                  ...
                  <button
                    ...
                    className="bg-[#4262ff] text-black px-6 py-2.5 rounded-full font-bold text-sm hover:opacity-95 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-1.5 shadow-lg shadow-[#4262ff]/20"
                  >
                    <CheckSvg />
                    Select Avatar
                  </button>
