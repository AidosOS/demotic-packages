...
const PRODUCT_NAME = "Mona Design";
const DEFAULT_NAMESPACE = "mona-design";

const descriptors: Record<ReleaseChannel, ReleaseChannelDescriptor> = {
  beta: {
    appId: "io.mona-design.desktop.beta",
    baseVersionField: "baseVersion",
    channel: "beta",
    displayLabel: "Beta",
  ...
  betas: {
    appId: "io.mona-design.desktop.betas",
    baseVersionField: "baseVersion",
    channel: "betas",
    counterField: "releaseNumber",
    displayLabel: "Betas",
  ...
  preview: {
    appId: "io.mona-design.desktop.preview",
    baseVersionField: "baseVersion",
    channel: "preview",
    counterField: "releaseNumber",
