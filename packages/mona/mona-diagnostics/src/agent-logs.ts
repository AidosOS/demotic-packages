...
export interface AgentCliLogOptions {
  ...
  homeDir: string;
  /** Mona Design data dir (OD_DATA_DIR); fallback location of the AMR OpenCode home. */
  dataDir?: string | null;
  /**
...
/**
 * Collect the native on-disk logs of the coding-agent CLIs Mona Design drives:
