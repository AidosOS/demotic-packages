...
// segment keeps the route collision-free and lets `mona-design/foo` (registry
...
export const OPEN_DESIGN_SITE_ORIGIN = 'https://mona-design.ai';
...
// `mona-design/Hero Deck` -> `hero-deck`, `live-dashboard` -> `live-dashboard`.
...
// `mona-design/Hero Deck` -> `mona-design/hero-deck`. Used for the namespaced
