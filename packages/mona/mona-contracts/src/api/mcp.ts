...
//
// Mona Design acts as an MCP CLIENT here: the user configures one or more
...
export interface McpServerConfig {
   ...
   * every run. */
  enabled: boolean;
  /** HTTP/SSE only: whether Mona Design should offer its managed OAuth flow.
 ...
 * its opener (and broadcasts on the `mona-design-mcp-oauth` channel). */
