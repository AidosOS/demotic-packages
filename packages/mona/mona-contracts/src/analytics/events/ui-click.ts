...
// the "Share Mona Design" social grid, the Discord / social follow links and
...
// `go_amr` is the link that opens https://mona-design.ai/amr.
...
export interface HandoffClickProps {
  ...
  element:
    ...
    | 'copy_cli_prompt'
    // Open the Mona Design AMR website link.
    | 'amr_website';
