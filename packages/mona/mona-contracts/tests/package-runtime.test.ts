...
describe('@demotic/mona-contracts package runtime shape', () => {
  ...
  it('makes runtime exports importable through package exports', async () => {
    const contracts = await import('@demotic/mona-contracts');
    const amrWallet = await import('@demotic/mona-contracts/api/amrWallet');
    const connectionTest = await import('@demotic/mona-contracts/api/connectionTest');
    const research = await import('@demotic/mona-contracts/api/research');
    const handoff = await import('@demotic/mona-contracts/api/handoff');
    const critique = await import('@demotic/mona-contracts/critique');
