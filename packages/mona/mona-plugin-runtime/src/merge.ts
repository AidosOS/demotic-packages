import type { PluginManifest } from '@demotic/mona-contracts';

// Merge a sidecar `mona-design.json` PluginManifest with one or more adapter
// outputs. `mona-design.json` always wins (spec §5.4); adapter values fill
