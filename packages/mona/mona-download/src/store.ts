 ...
 * ownership sentinel that marks a base directory as Mona Design-owned, refuses to
...
/**
 * Ensure `basePath` is an Mona Design-owned managed base: create it if missing,
