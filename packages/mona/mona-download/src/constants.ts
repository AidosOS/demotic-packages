...
export const STORE_SENTINEL = ".mona-design-download-root.json";
...
export const STORE_KIND = "mona-design-managed-download-root";
/** Kind tag identifying a managed-download manifest. */
export const MANIFEST_KIND = "mona-design-managed-download";
