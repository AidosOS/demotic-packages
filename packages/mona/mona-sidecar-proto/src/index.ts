import { RELEASE_CHANNELS, type ReleaseChannel } from "@demotic/mona-release";
...
export const SIDECAR_DEFAULTS = Object.freeze({
  host: "127.0.0.1",
  ipcBase: "/tmp/mona-design/ipc",
  namespace: "default",
  projectTmpDirName: ".tmp",
  windowsPipePrefix: "mona-design",
} as const);

export const OPEN_DESIGN_PRODUCT_NAME = "Mona Design";
